...
class mx_acp
{
	...
	{
		global $board_config, $lang, $db, $template, $mx_user, $mx_root_path, $phpbb_root_path, $phpEx;
		...
		$this->menu_actions = array_merge(array( $this->action_script => isset($this->menu_actions[$this->action_script]) ? $this->menu_actions[$this->action_script] : array()), $this->menu_actions);
	}
