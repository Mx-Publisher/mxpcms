...
* @version $Id: lang_admin.php,v 1.11 2013/06/28 17:08:52 orynider Exp $
...
$lang['Click_return_portal_config'] 		= 'Klicka %shär%s för att ĺtergĺ till Portalkonfigurationen';
...
$lang['Portal_status_explain'] 				= 'Praktisk switch när admin underhĺller sajten. När MX-Publisher är inaktiverad visas meddelandet nedan.';
...
$lang['Portal_config_valid_false'] 			= '<b><font color="red">Fel. Antingen är din relativa sökväg till phpBB felaktig, eller sĺ är phpBB inte installerat (din phpBB databas hittas inte). Sĺlunda använda \'internal\'.</font></b>';
...
/*  Module Installation*/
$lang['Module_delete_db']   		= 'Vill du avinstallera modulen? Varning: denna data kan inte ĺterskapas. Överväg att uppgradera istället...';
...
$lang['Error_no_db_upgrade'] 		= 'Fel: filen db_upgrade.php finns inte eller sĺ stöds inte uppgraderingsmöjligheterna av denna modul. Vänligen verifiera och försök igen...';
...
$lang['import_module_pack_explain']	= 'Detta kommmer installera en portalmodul. Var säker pĺ att portalmodulen är uppladdad till /portalmodul mappen... och använd den senaste versionen!';
$lang['upgrade_module_pack']       	= 'Upgradera portalmodul';
$lang['upgrade_module_pack_explain']= 'Detta kommer uppgradera din portalmodul. Var säker pĺ att läsa dokumentationen innan du fortsätter, annars kan du förlora data.';
...
$lang['Click_return_module_admin'] 	= 'Klicka %shär%s för att ĺtergĺ till moduladministrationen';
...
$lang['Delete_function_explain']	= 'Vill du ta bort blockfunktion, och uppdatera alla associerade portalblock? Varning, detta val kan inte ĺngras!';
...
$lang['Parameter_name']            	= '<b>Namn</b><br />- används för ĺtkomst av parametern';
...
$lang['Delete_parameter_explain']		= 'Vill du ta bort funktionsparametern, och uppdatera alla associerade portalblock? Varning, detta val kan inte ĺngras!';
...
$lang['Delete_block_explain']		= 'Vill du ta bort portalblocket, och uppdatera alla portalsidor? Varning, detta val kan inte ĺngras!';
$lang['Click_block_delete_yes']		= 'Klicka %shär%s för att ta bort portalblocket';

/*  BlockCP Administration*/
$lang['Block_cp']                  	= 'Kontrollpanel';
$lang['Click_return_blockCP_admin']	= 'Klicka %sHär%s för att ĺtervända till kontrollpanelen';
$lang['Click_return_portalpage_admin']	= 'Klicka %sHär%s för att ĺtervända till portalsidan';
...
$lang['Override_page_style'] 		= 'Ĺsidosätt användarstil';
...
$lang['Return_to_page']            	= 'Ĺtergĺ till portalsidan';
...
$lang['Click_return_page_admin']   	= 'Klicka %shär%s för att ĺtervända till portalsidaadministrationen';
$lang['Remove_block']				= 'Ta bort portalblock';
$lang['Remove_block_explain']		= 'Vill du ta bort portalblocket frĺn sidan? Varning, detta val kan inte ĺngras!';
$lang['Click_block_remove_yes']		= 'Klicka %shär%s för att ta bort portalblocket';
$lang['Delete_page']				= 'Ta bort sidan';
$lang['Delete_page_explain']		= 'Vill du ta bort sidan? Varning, detta val kan inte ĺngras!';
$lang['Click_page_delete_yes']		= 'Klicka %shär%s för att ta bort sidan';

$lang['Mx_IP_filter']				= 'IP filter';
$lang['Mx_IP_filter_explain']		= 'För att begränsa tillträde till sidan baserat pĺ IP, ange godkända IP-adresser - en per rad. <br> T ex 127.0.0.1 eller 127.0.*.*';
...
$lang['Column_Size']               	= 'Storleken pĺ kolumnen';
...
$lang['Delete_page_column_explain']		= 'Vill du ta bort sidkolumnen? Varning, detta val kan inte ĺngras!';
...
$lang['Add_Dynamic_Block_explain'] 	= 'Detta block är ett dynamiskt block, vars innehĺll bestäms via navigeringsmenyn';
...
$lang['Page_templates_admin_explain'] = 'Pĺ denna sida kan du skapa, ändra och ta bort sidmallar';
...
$lang['Delete_page_template_explain']	= 'Vill du ta bort sidmallen? Varning, detta val kan inte ĺngras!';
...
$lang['Delete_page_template_column_explain']	= 'Vill du ta bort sidmallskolumnen? Varning, detta val kan inte ĺngras!';
...
$lang['Cache_explain']             	= 'Nu kan du skapa alla xml-filer (cachefiler) för systemet. Dessa filer hjälper till att minska antalet frĺgor till databasen och förbättra portalprestandan.<br />Notera: Du mĺste aktivera cachefunktionen (Portal hantering adminCP) för att cachefilerna skall läsas.<br />Notera vidare: Cachefilerna skapas automatiskt av systemet när block ändras.';
...
$lang['Click_return_block_auth'] 	= 'Klicka %shär%s för att ĺtergĺ till blockrättigheterna';
$lang['Page_Auth_successfully'] 	= 'Sidrättigheterna uppdaterades...';
$lang['Click_return_page_auth'] 	= 'Klicka %shär%s för att ĺtergĺ till sidrättigheterna';
$lang['AUTH_ALL']                  	= 'ALLA';
$lang['AUTH_REG']                  	= 'REG';
...
$lang['block_sizes_explain']   		= '- använd relativa mĺtt, t ex \'40%\' och \'*\' för att fylla ut';
$lang['space_between'] 				= 'Mellanrum';

/** Stats */
$lang['log_filter_date'] 			= 'Datumfilter';
$lang['log_filter_date_explain'] 	= '- Visa log frĺn senaste dagen, veckan, mĺndaden, ĺret...';
...
$lang['x_mode_explain'] 			= '- IncludeX blocket används pĺ olika sätt beroende pĺ funktionsval. Om du väljer \'Lyssna (GET)\', bestäms funktionen genom att skicka med informationen i urlen: \'x_mode=mode\' och associerade parametrar \'x_1=, x_2=, etc\'.<br />Exemplel: För att använda en url i en iframe: \'domain/index.php?page=x&x_mode=iframe&x_1=http://domain\'  ';
$lang['x_1'] 						= 'Variabel 1:';
...
$lang['menu_custom_tpl_explain ']		= 'Filnamn pĺ alternativ stilfil, t ex mx_menu_custom.tpl';
$lang['menu_page_parent']				= 'Toppsida';
$lang['menu_page_parent_explain ']		= 'Navigera frĺn denna sida och ner';
