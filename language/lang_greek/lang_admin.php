...
$lang['Mx-Publisher_adminCP'] = 'Διαχείριση MX-Publisher';
...
/* Version Checker */
$lang['MXP_Version_up_to_date'] = 'Η εγκατάσταση του MX-Publisher είναι ενημερωμένη. Καμία αναβάθμιση δεν είναι διαθέσιμη για την έκδοση του MX-Publisher.';
$lang['MXP_Version_outdated'] = 'Η εγκατάσταση του MX-Publisher <b>δεν</b> φαίνεται να είναι ενημερωμένη. Αναβαθμίσεις είναι διαθέσιμες για την έκδοση του MX-Publisher. Παρακαλώ επισκεφτείτε <a href="http://mxpcms.sourceforge.net/index.php?page=4&action=file&file_id=2" target="_new">the MX-Publisher Core package download</a> για να αποκτήσετε την πιο πρόσφατη έκδοση.';
$lang['MXP_Latest_version_info'] = 'Η πιό πρόσφατη διαθέσιμη έκδοση είναι <b>MX-Publisher %s</b>. ';
$lang['MXP_Current_version_info'] = 'Τρέχετε <b>MX-Publisher %s</b>.';
$lang['MXP_Mailing_list_subscribe_reminder'] = 'Για τις πιο πρόσφατες πληροφορίες για ειδήσεις και αναβαθμίσεις του, γιατί όχι <a href="http://lists.sourceforge.net/lists/listinfo/mxpcms-news" target="_new">εγγραφείτε στον κατάλογο αλληλογραφίας</a>?';
