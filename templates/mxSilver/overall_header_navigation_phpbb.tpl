...
<table width="850" cellspacing="0" cellpadding="1" border="0" align="center" class="mx_main_table">
	<tr>
			...
			<table width="100%" cellspacing="0" cellpadding="2" border="0" align="center">
				<tr>
					...
					<td valign="top" align="right" width="100%" height="5" >
						...
						-->
						<a href="http://www.mx-publisher.com/page144" class="gen"><span class="gen"><b>[{L_SEARCH}]</b></span></a>
					</td>
