	...
	<tr>
		<td align="center" >
			<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
				...
				<!-- BEGIN module_phpbb -->
				<tr>
					<td class="row1"><span class="genmed"><a href="{module_phpbb.U_FORUM_INDEX}" target="_parent" class="genmed">{module_phpbb.L_FORUM_INDEX}</a></span></td>
				</tr>
				<tr>
					<td class="row1"><span class="genmed"><a href="{module_phpbb.U_FORUM_INDEX}" target="main" class="genmed">{module_phpbb.L_PREVIEW_FORUM}</a></span></td>
				</tr>
				<!-- END module_phpbb -->
				<tr>
