...
class mx_lock_db
{
	...
	*/
	public function __construct($config_name, mx_config $portal_config, mx_db_driver $db)
	{
		$this->portal_config_name = $config_name;
	...
	*/
	public function acquire()
	{
		...
		if (!isset($this->portal_config[$this->portal_config_name]))
		{
			$this->portal_config->set($this->portal_config_name, '0', false);
		}
		$lock_value = $this->portal_config[$this->portal_config_name];
		...
		$this->locked = $this->portal_config->set_atomic($this->portal_config_name, $lock_value, $this->unique_id, false);
	...
	*/
	public function release()
	{
		if ($this->locked)
		{
			$this->portal_config->set_atomic($this->portal_config_name, $this->unique_id, '0', false);
			$this->locked = false;
		}
	}
}
