...
{
	global $phpbb_auth, $mx_user, $config, $db, $mx_cache;
	...
	$extensions = $mx_cache->obtain_attach_extensions((($is_message) ? false : (int) $forum_id));
...
{
	global $mx_user, $phpbb_auth, $db, $template, $bbcode, $mx_cache;
