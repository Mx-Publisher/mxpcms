...
$lang = array_merge($lang, array(
	...
	'ACP_BAN_USERNAMES'			=> 'Interzicere nume utilizatori',
	...
	'ACP_CAT_CUSTOMISE'			=> 'Personalizare',
	...
	'ACP_CONTACT'				=> 'Pagina de contact',
	'ACP_CONTACT_SETTINGS'		=> 'Setări pagina de contact',
	...
	'ACP_EXTENSION_MANAGEMENT'	=> 'Administrare extensii',
	'ACP_EXTENSIONS'			=> 'Administrarea extensiilor',
	...
	'ACP_MANAGE_ATTACHMENTS'			=> 'Administrare fișiere atașate',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Aici puteți vedea și sterge fișierele atașate în mesaje și în mesaje private.',
	...
	'ACP_STYLES'				=> 'Stiluri',
	'ACP_STYLES_CACHE'			=> 'Curăță cache',
	'ACP_STYLES_INSTALL'		=> 'Instalare stiluri',
	...
	'CRON_LOCK_ERROR'		=> 'Nu se poate obține încuierea cron.',
	'CRON_NO_SUCH_TASK'		=> 'Nu poate fi găsită sarcina cron “%s.',
	'CRON_NO_TASK'			=> 'Ne este necesară rularea unor sarcini cron chiar acum.',
	'CRON_NO_TASKS'			=> 'Nu au fost găsite sarcini cron.',
	...
	'LOAD_NOTIFICATIONS'			=> 'Afișează notificări',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Afișează lista notificărilor în fiecare pagină (de regulă în partea de sus a paginii).',
	...
	'NO_FILES_TO_DELETE'	=> 'Fișierele atașate selectate pentru ștergere nu există.',
	...
	'TASKS_NOT_READY'		=> 'Sarcini care nu sunt gata de rulare:',
	'TASKS_READY'			=> 'Sarcini pregătite:',
	'TOTAL_SIZE'			=> 'Mărime totală',
...
$lang = array_merge($lang, array(
	...
	'NO_SEARCH_INDEX'	=> 'Căutarea backend selectată nu are un index de căutare.<br />Vă rugăm creați un index de căutare pentru “%1$s” în secțiunea %2$sindexare căutare%3$s.',
	...
	'PURGE_CACHE_SUCCESS'	=> 'Cache șters cu succes.',
	...
	'PURGE_SESSIONS_SUCCESS'	=> 'Sesiuni șterse cu succes.',
	...
	'RESET_DATE_SUCCESS'			=> 'Data de start a forumului a fost resetată',
	...
	'RESET_ONLINE_SUCCESS'			=> 'Contorul care indică cei mai mulţi utilizatori online a fost resetat',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'		=> 'Contorul mesajelor a fost resincronizat',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Subiectele punctate au fost resincronizate',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Statisticile au fost resincronizate',
	'RUN'							=> 'Porneşte acum',
	...
	'TIMEZONE_SELECTED'	=> '(selectat curent)',
...
$lang = array_merge($lang, array(
	...
	'LOG_BUMP_TOPIC'			=> '<strong>Subiectul utilizatorului adus în atenţie</strong><br />» %s',
	'LOG_DELETE_POST'			=> '<strong>Mesaj șters „%1$s” scris de „%2$s” pentru următorul motiv</strong><br />» %3$s',
	'LOG_DELETE_SHADOW_TOPIC'   => '<strong>Subiect umbră şters</strong><br />» %s',
	'LOG_DELETE_TOPIC'          => '<strong>Subiect șters „%1$s” scris de „%2$s” pentru următorul motiv</strong><br />» %3$s',
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Subiect mutat</strong><br />» %s',
	...
	'LOG_POST_DISAPPROVED'		=> '<strong>Mesaj neaprobat „%1$s” scris de către „%3$s” din următorul motiv</strong><br />» %2$s',
	'LOG_POST_EDITED'			=> '<strong>Mesaj modificat „%1$s” scris de către „%2$s” din următorul motiv</strong><br />» %3$s',
	'LOG_POST_RESTORED'			=> '<strong>Mesaj restaurat</strong><br />» %s',
	'LOG_REPORT_CLOSED'			=> '<strong>Raport închis</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Raport şters</strong><br />» %s',
	'LOG_RESTORE_TOPIC'			=> '<strong>Subiect restaurat “%1$s” scris de către </strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'		=> '<strong>Mesaj șters “%1$s” scris de către “%2$s” pentru următorul motiv</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'		=> '<strong>Subiect șters “%1$s” scris de către “%2$s” pentru următorul motiv</strong><br />» %3$s',
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Subiect restaurat</strong><br />» %s',
	'LOG_TOPIC_DISAPPROVED'		=> '<strong>Subiect neaprobat „%1$s” scris de către „%3$s” din următorul motiv</strong><br />%2$s',
	'LOG_TOPIC_RESYNC'			=> '<strong>Contoare subiecte resincronizate</strong><br />» %s',
	...
	'LOG_ERROR_CAPTCHA'		=> '<strong>Eroare CAPTCHA</strong><br />» %s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>Imposibil de deschis %1$s pentru aranjare, verificați permisiunile.</strong><br />Exceptie: %2$s<br />Urme: %3$s',
	...
	'LOG_PRUNE_SHADOW'		    => '<strong>Umbre de subiecte șterse automat</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Resincronizări ale statisticii fișierelor</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Eroare Sphinx</strong><br />» %s',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Avertisment utilizator șters</strong><br />» %1$s',
		2 => '<strong>Au fost șterse %2$d avertismente</strong><br />» %1$s', // Examplu: '<strong>Șterse 2 avertismente </strong><br />» pentru utilizator'
	),
	...
	'LOG_EXT_ENABLE'	=> '<strong>Extensie activată</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>Extensie dezactivată</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>Date extensii șterse</strong><br />» %s',
));
