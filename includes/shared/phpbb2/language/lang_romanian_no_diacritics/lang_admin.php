 ...
 *
 *     $Id: lang_admin.php,v 1.1 2008/06/16 14:39:54 orynider Exp $
 *
 ****************************************************************************/
...
$lang['Allow_autologin'] = 'Permite autentificari automate';
$lang['Allow_autologin_explain'] = 'Determina daca utilizatorii au voie sa selecteze sa fie autentificati automat cand viziteaza forumul.';
$lang['Autologin_time'] = 'Expirarea cheii de autentificare automata.';
$lang['Autologin_time_explain'] = 'Cate zile este valida o cheie de autentificare automata daca utilizatorul nu viziteaza forumul. Seteaza 0 pentru a dezactiva expirarea.';

// Intervalul limita pentru cautari - adaugat la 2.0.20
$lang['Search_Flood_Interval'] = 'Intervalul limita pentru cautari';
$lang['Search_Flood_Interval_explain'] = 'Numarul de secunde pe care un utilizator trebuie sa-l astepte intre cautari'; 
...
$lang['Confirm_delete_smiley'] = 'Sunteti sigur ca doriti sa stergeti acest zambet ?';
...
$lang['Confirm_delete_word'] = 'Sunteti sigur ca doriti sa stergeti acest acest cuvant cenzurat ?';
...
$lang['Stylesheet_explain'] = 'Numele fisierului pentru stilul CSS folosit in aceasta tema.';
...
// Version Check
//
$lang['Version_up_to_date'] = 'Forumul dumneavoastra foloseste ultima versiune phpBB. Nu sunt actualizari disponibile pentru versiunea dumneavoastra.';
$lang['Version_not_up_to_date'] = 'Forumul dumneavoastra pare sa <b>nu</b> fie actualizat. Noile versiuni sunt disponibile la adresa <a href="http://www.phpbb.com/downloads.php" target="_new">http://www.phpbb.com/downloads.php</a>.';
$lang['Latest_version_info'] = 'Cea mai noua versiune este <b>phpBB %s</b>.';
$lang['Current_version_info'] = 'Folositi <b>phpBB %s</b>.';
$lang['Connect_socket_error'] = 'Nu am putut deschide conexiunea cu serverul phpBB, eroarea raportata este:<br />%s';
$lang['Socket_functions_disabled'] = 'Nu am putut folosi functiile socket.';
$lang['Mailing_list_subscribe_reminder'] = 'Pentru cele mai noi informatii despre phpBB, <a href="http://www.phpbb.com/support/" target="_new">va puteti inscrie la serviciul de stiri</a>.';
$lang['Version_information'] = 'Informatii despre versiuni';

//
// Login attempts configuration
//
$lang['Max_login_attempts'] = 'Permite incercari de autentificare';
$lang['Max_login_attempts_explain'] = 'Numarul de incercari de autentificare permise.';
$lang['Login_reset_time'] = 'Timpul necesar reautentificarii';
$lang['Login_reset_time_explain'] = 'Numarul de minute pe care un user trebuie sa-l astepte pentru a i se permite sa se autentifice din nou, dupa depasirea numarului de incercari de autentificare permise.';
