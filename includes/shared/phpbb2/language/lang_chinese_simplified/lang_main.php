...
// please add it here.
$lang['TRANSLATION'] = 'phpBB 简体中文界面由 iCy-fLaME 更新翻译';
$lang['TRANSLATION_INFO'] = 'phpBB 简体中文界面由 iCy-fLaME 更新翻译';
//
...
$lang['Click_return_modcp'] = "点击 %s这里%s 返回长老管理区";
$lang['Click_return_group'] = "点击 %s这里%s 返回成员组信息区(to return to group information)";

$lang['Admin_panel'] = "论坛管理员控制面板";

$lang['Board_disable'] = "对不起,本论坛暂时不能访问,请稍后在试.";


//
// Global Header strings
//
$lang['Registered_users'] = "注册成员:";
$lang['Browsing_forum'] = "正在浏览这个版面的成员:";
...
$lang['Reg_users_zero_total'] = "0 位成员, ";
$lang['Reg_users_total'] = "%d 位成员, ";
$lang['Reg_user_total'] = "%d 位成员, ";
$lang['Hidden_users_zero_total'] = "0 位隐身客和 ";
$lang['Hidden_user_total'] = "%d 位隐身客和 ";
$lang['Hidden_users_total'] = "%d 位隐身客和 ";
...
$lang['Registered_users_zero_total'] = "论坛共还没有注册成员"; // # registered users
$lang['Registered_users_total'] = "论坛共有 <b>%d</b> 位注册成员"; // # registered users
$lang['Registered_user_total'] = "论坛共有 <b>%d</b> 位注册成员"; // # registered users
$lang['Newest_user'] = "最新注册的成员是 <b>%s%s%s</b>"; // a href, username, /a
...
$lang['Private_Message'] = "私人留言";
$lang['Private_Messages'] = "私人留言";
...
$lang['Rules_vote_can'] = "您<b>可以</b>在这个论坛发表民意调查";
$lang['Rules_vote_cannot'] = "您<b>不能</b>在这个论坛发表民意调查";
...
$lang['Read_profile'] = "阅览成员资料 (Profile)";
$lang['Send_email'] = "给成员发电子邮件";
...
$lang['Confirm_delete_poll'] = "您确定要删除这个民意调查吗?";
...
$lang['Cannot_delete_poll'] = "对不起您不可以删除正处于活动状态的民意调查.";
$lang['Empty_poll_title'] = "您必须给您发表的民意调查建立一个主题.";
$lang['To_few_poll_options'] = "您必须要建立至少两个民意调查的选项.";
$lang['To_many_poll_options'] = "您选择建立太多的民意调查的选项";
$lang['Post_has_no_poll'] = "这个主题没有建立民意调查";
$lang['Already_voted'] = '你已经在这里投过票了.';
$lang['No_vote_option'] = '你必须选择一个项目.';

$lang['Add_poll'] = "建立一个民意调查";
$lang['Add_poll_explain'] = "如果您不想建立民意调查请不要填写这个选项.";
$lang['Poll_question'] = "民意调查主题";
$lang['Poll_option'] = "民意调查选项";
$lang['Add_option'] = "建立选项";
$lang['Update'] = "更新";
$lang['Delete'] = "删除";
$lang['Poll_for'] = "民意调查期限";
$lang['Days'] = "天内"; // This is used for the Run poll for ... Days + in admin_forums for pruning
$lang['Poll_for_explain'] = "[ 选择 0 或者不选择这个选项代表永远运行民意调查 ]";
$lang['Delete_poll'] = "删除民意调查";
...
$lang['Poll_delete'] = "您建立的民意调查已经成功的被删除";
...
// Private Messaging
//
$lang['Private_Messaging'] = "私人留言";

$lang['Login_check_pm'] = "登陆查看您的私人留言";
$lang['New_pms'] = "您有 %d 封新的留言"; // You have 2 new messages
$lang['New_pm'] = "您有 %d 封新的留言"; // You have 1 new message
$lang['No_new_pm'] = "您没有新的留言";
$lang['Unread_pms'] = "您有 %d 封未读的留言";
$lang['Unread_pm'] = "您有 %d 封未读的留言";
$lang['No_unread_pm'] = "您没有未读的留言";
$lang['You_new_pm'] = "一封新的留言在您的收件夹里";
$lang['You_new_pms'] = "几封新的留言在您的收件夹里";
$lang['You_no_new_pm'] = "没有新的留言";

$lang['Unread_message'] = '未读留言';
$lang['Read_message'] = '已读留言';

$lang['Read_pm'] = '查看私人留言';
$lang['Post_new_pm'] = '发送私人留言';
$lang['Post_reply_pm'] = '回复留言';
$lang['Post_quote_pm'] = '引用留言';
$lang['Edit_pm'] = '编辑私人留言';
...
$lang['Sent'] = "发送";
$lang['Saved'] = "已保存到收藏夹";
$lang['Delete_marked'] = "删除已选择的留言";
$lang['Delete_all'] = "删除所有的留言";
$lang['Save_marked'] = "保存已选择的留言到收藏夹";
$lang['Save_message'] = "保存留言到收藏夹";
$lang['Delete_message'] = "删除留言";

$lang['Display_messages'] = "显示以前的帖子"; // Followed by number of days/weeks/months
$lang['All_Messages'] = "所有的留言";

$lang['No_messages_folder'] = "这个文件夹里没有信件";

$lang['PM_disabled'] = "这个论坛的私人留言已经被禁用";
$lang['Cannot_send_privmsg'] = "对不起论坛管理员已经禁止您发送私人留言";
$lang['No_to_user'] = "您必须指定私人留言发送的对象";
...
$lang['Message_sent'] = "您的私人留言发送成功";

$lang['Click_return_inbox'] = "点击 %s这里%s 返回您的收件夹";
$lang['Click_return_index'] = "点击 %s这里%s 返回首页";

$lang['Send_a_new_message'] = "发送一个新的私人留言";
$lang['Send_a_reply'] = "回复留言";
$lang['Edit_message'] = "编辑留言";

$lang['Notification_subject'] = "新的私人留言";
...
$lang['Confirm_delete_pm'] = "您确定要删除这封留言吗?";
$lang['Confirm_delete_pms'] = "您确定要删除这些留言吗?";
...
//
$lang['Viewing_user_profile'] = "个人资料 :: %s"; // %s is username
...
$lang['Email'] = "Email";
$lang['Send_private_message'] = "发送私人留言 (PM)";
...
$lang['Upload_Avatar_file'] = '从你的电脑上传你的头像';
...
$lang['Select_from_gallery'] = "从系统的头像相册里选择一个头像";
$lang['View_avatar_gallery'] = "显示系统头像相册";
...
$lang['Notify_on_privmsg'] = "当有新的私人留言时发送电子邮件通知";
$lang['Popup_on_privmsg'] = "当有新的私人留言时弹出窗口通知";
$lang['Popup_on_privmsg_explain'] = "当您有新的私人留言时弹出窗口来通知您";
...
$lang['Too_many_registers'] = '你登记得太频繁. 请稍后再试.';
...
$lang['Already_activated'] = '你的帐号已经激活';
...
$lang['User_prevent_email'] = "这名用户不希望收到电子邮件,您可以发送私人留言 (PM)给这名用户";
...
//
$lang['Confirm_code_wrong'] = '你输入的验证码不正确';
$lang['Too_many_registers'] = '你已经超过了允许的尝试次数上限. 请稍后再试.';
$lang['Confirm_code_impaired'] = '假如你有视觉障碍, 或者无法看见验证码请联络%s论坛管理员%s.';
$lang['Confirm_code'] = '验证码';
$lang['Confirm_code_explain'] = '完整输入你看见的验证码. 验证码是大小写有别的, 数字 "零" 的中间会有一斜线.';
...
// Group control panel
//
$lang['Group_Control_Panel'] = "成员组控制面板";
$lang['Group_member_details'] = "成员组成员细节";
$lang['Group_member_join'] = "加入一个成员组";

$lang['Group_Information'] = "成员组信息";
$lang['Group_name'] = "成员组名称";
$lang['Group_description'] = "成员组描述";
$lang['Group_membership'] = "成员组成员";
$lang['Group_Members'] = "成员组成员";
$lang['Group_Moderator'] = "成员组主席";
$lang['Pending_members'] = "审核中的成员";

$lang['Group_type'] = "成员组类型";
$lang['Group_open'] = "开启成员组";
$lang['Group_closed'] = "关闭成员组";
$lang['Group_hidden'] = "隐藏成员组";

$lang['Current_memberships'] = "目前您所在的成员组";
$lang['Non_member_groups'] = "没有成员的成员组";
$lang['Memberships_pending'] = "您正在被审核中的成员组";

$lang['No_groups_exist'] = "没有成员组存在";
$lang['Group_not_exist'] = "不存在这个成员组";

$lang['Join_group'] = "加入成员组";
$lang['No_group_members'] = "这个成员组没有成员";
$lang['Group_hidden_members'] = "这个成员组处于隐藏状态,您不能查看它的成员";
$lang['No_pending_group_members'] = "这个成员组不存在审核中成员";
$lang["Group_joined"] = "您已经申请加入这个成员组,<br />当您的申请通过审核您将受到通知";
$lang['Group_request'] = "加入这个成员组的申请已经提交";
$lang['Group_approved'] = "您的申请已经被批准了";
$lang['Group_added'] = "您已经被加入这个成员组";
$lang['Already_member_group'] = "您已经是这个成员组的成员";
$lang['User_is_member_group'] = "用户已经是这个成员组的成员";
$lang['Group_type_updated'] = "成功更新成员组类型";

$lang['Could_not_add_user'] = "您选择的用户不存在";
$lang['Could_not_anon_user'] = "您不能将匿名游客列为成员组成员";

$lang['Confirm_unsub'] = "您确定要从这个成员组解除申请吗?";
$lang['Confirm_unsub_pending'] = "您的成员组申请还没有被批准,您确定要解除申请吗?";

$lang['Unsub_success'] = "您已经从这个成员组解除了申请.";

$lang['Approve_selected'] = "选择批准";
$lang['Deny_selected'] = "选择拒绝";
$lang['Not_logged_in'] = "加入成员组前您必须首先登陆.";
$lang['Remove_selected'] = "选择移除";
$lang['Add_member'] = "增加成员";
$lang['Not_group_moderator'] = "您不是这个成员组的管理员,您无法执行成员组的管理功能.";

$lang['Login_to_join'] = "请登陆加入或者管理成员组成员";
$lang['This_open_group'] = "这是一个开放的成员组,点击申请成员";
$lang['This_closed_group'] = "这是一个关闭的成员组,不接受新的成员";
$lang['This_hidden_group'] = "这是一个隐藏的成员组,不容许自动增加成员";
$lang['Member_this_group'] = "您是这个成员组的成员";
$lang['Pending_this_group'] = "您的申请正在审核中";
$lang['Are_group_moderator'] = "您是成员组管理员";
$lang['None'] = "没有";
...
$lang['tz']['-12'] = "(GMT -12:00 小时) 埃尼威托克岛, 夸贾林岛";
$lang['tz']['-11'] = "(GMT -11:00 小时) 中途岛, 萨摩亚群岛";
$lang['tz']['-10'] = "(GMT -10:00 小时) 夏威夷州";
$lang['tz']['-9'] = "(GMT -9:00 小时) 阿拉斯加州";
$lang['tz']['-8'] = "(GMT -8:00 小时) 太平洋时间 (美国 &amp; 加拿大), 提华纳";
$lang['tz']['-7'] = "(GMT -7:00 小时) 山地标准时间 (美国 &amp; 加拿大), 亚利桑那州";
$lang['tz']['-6'] = "(GMT -6:00 小时) 中区时 (美国 &amp; 加拿大), 墨西哥城";
$lang['tz']['-5'] = "(GMT -5:00 小时) 东部时间 (美国 &amp; 加拿大), 波哥大, 利马, 基多";
$lang['tz']['-4'] = "(GMT -4:00 小时) 大西洋时间 (加拿大), 加拉加斯, 拉巴斯";
$lang['tz']['-3.5'] = "(GMT -3:30 小时) 纽芬兰";
$lang['tz']['-3'] = "(GMT -3:00 小时) 巴西, 布宜诺斯艾利斯, 乔治顿, 福克兰群岛";
$lang['tz']['-2'] = "(GMT -2:00 小时) 中大西洋, 亚森松岛, 圣赫勒您";
$lang['tz']['-1'] = "(GMT -1:00 小时) 亚速尔群岛, 维德角岛";
$lang['tz']['0'] = "(GMT) 卡萨布兰卡, 都柏林, 爱丁堡, 伦敦, 里斯本, 蒙罗维亚";
$lang['tz']['1'] = "(GMT +1:00 小时) 阿姆斯特丹, 柏林, 布鲁塞尔, 哥本哈根, 马德里, 巴黎, 罗马";
$lang['tz']['2'] = "(GMT +2:00 小时) 开罗, 赫尔辛基, 加里宁格勒, 南非";
$lang['tz']['3'] = "(GMT +3:00 小时) 巴格达, 利雅德, 莫斯科, 内罗毕";
$lang['tz']['3.5'] = "(GMT +3:30 小时) 德黑兰";
$lang['tz']['4'] = "(GMT +4:00 小时) 阿布扎比, 巴库, 马斯喀特, 第比利斯";
$lang['tz']['4.5'] = "(GMT +4:30 小时) 喀布尔";
$lang['tz']['5'] = "(GMT +5:00 小时) 伊卡特琳堡, 伊斯兰堡, 卡拉奇, 塔什干";
$lang['tz']['5.5'] = "(GMT +5:30 小时) 孟买, 加尔各答, 马德拉斯, 新德里";
$lang['tz']['6'] = "(GMT +6:00 小时) 阿蒙提, 科伦坡, 达卡，新西伯利亚";
$lang['tz']['6.5'] = "(GMT +6:30 小时) 仰光";
$lang['tz']['7'] = "(GMT +7:00 小时) 曼谷, 河内, 雅加达";
$lang['tz']['8'] = "(GMT +8:00 小时) 北京, 香港, 佩思, 新加坡, 台北";
$lang['tz']['9'] = "(GMT +9:00 小时) 大阪, 札幌, 汉城, 东京, 雅库茨克";
$lang['tz']['9.5'] = "(GMT +9:30 小时) 阿得雷德, 达尔文";
$lang['tz']['10'] = "(GMT +10:00 小时) 堪培拉，关岛，莫尔本, 悉尼, 符拉迪沃斯托克";
$lang['tz']['11'] = "(GMT +11:00 小时) 马加丹, 新卡里多尼亚, 所罗门群岛";
$lang['tz']['12'] = "(GMT +12:00 小时) 奥克兰, 威灵顿, 斐济, 马歇尔群岛";
$lang['tz']['13'] = "(GMT +13:00 小时) 努库阿洛法";
