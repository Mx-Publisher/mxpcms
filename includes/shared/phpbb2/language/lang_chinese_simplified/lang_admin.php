...
$lang['Select_a_Group'] = "选择一个成员组";
$lang['Select_a_Forum'] = "选择一个版面";
$lang['Auth_Control_User'] = "会员权限设定";
$lang['Auth_Control_Group'] = "成员组权限设定";
$lang['Auth_Control_Forum'] = "版面权限设定";
$lang['Look_up_User'] = "查询会员";
$lang['Look_up_Group'] = "查询成员组";
$lang['Look_up_Forum'] = "查询版面";

$lang['Group_auth_explain'] = "在这个选项中您可以更改成员组的权限设定及指定管理员资格. 请注意, 修改成员组权限设定后, 独立的会员权限可能仍然可以使会员进入限制版面. 如果发生这种情况将会显示权限冲突的警告.";
...
$lang['Conflict_access_userauth'] = "这个会员仍然可以通过成员组成员的资格进入特定的版面. 您可以更改成员组权限或是取消这个会员的成员组资格来禁止该会员进入限制的版面.成员组权限如下:";
$lang['Conflict_mod_userauth'] = "这个会员仍然可以通过成员组成员的资格拥有版面管理的权限. 您可以更改成员组权限或是取消这个会员的权限来禁止该会员进行版面管理.版面管理权限如下:";
...
$lang['Group_memberships'] = "会员成员组列表";
$lang['Usergroup_members'] = "成员组成员列表";

$lang['Forum_auth_updated'] = "版面权限设定更新";
$lang['User_auth_updated'] = "会员权限设定更新";
$lang['Group_auth_updated'] = "成员组权限设定更新";

$lang['Auth_updated'] = "权限设定已经更新";
$lang['Click_return_userauth'] = "点击 %s这里%s 返回会员权限设定";
$lang['Click_return_groupauth'] = "点击 %s这里%s 返回成员组权限设定";
...
$lang['Cookie_secure_explain'] = '如果您的服务器使用 SSL, 请使用该选项';
$lang['Session_length'] = "Session 存活时间 [ 秒 ]";

// Visual Confirmation
$lang['Visual_confirm'] = '使用视觉验证';
$lang['Visual_confirm_explain'] = '要求用者在注册的时候输入由图形定义的验证码.';
...
$lang['Status_locked'] = '已冻结';
$lang['Status_unlocked'] = '开放';
...
$lang['User_admin_explain'] = "在这个控制面板里, 您可以变更会员的个人资料以及现存的特殊选项. 如果您要修改会员的权限, 请使用会员及成员组管理的权限设定功能.";
...
// Group Management
//
$lang['Group_administration'] = "成员组管理";
$lang['Group_admin_explain'] = "在这个控制面板里您可以管理所有的成员组, 您可以建立, 删除以及编辑现存的成员组. 您可以指定成员组管理员, 设定成员组模式 (开放/封闭/隐藏) 以及成员组的名称和描述.";
$lang['Error_updating_groups'] = "成员组更新时发生错误";
$lang['Updated_group'] = "成员组已经成功更新";
$lang['Added_new_group'] = "新的成员组已经成功加入";
$lang['Deleted_group'] = "成员组已被顺利删除";
$lang['New_group'] = "建立新成员组";
$lang['Edit_group'] = "编辑成员组";
$lang['group_name'] = "成员组名称";
$lang['group_description'] = "成员组描述";
$lang['group_moderator'] = "成员组管理员";
$lang['group_status'] = "成员组状态";
$lang['group_open'] = "开放成员组";
$lang['group_closed'] = "关闭成员组";
$lang['group_hidden'] = "隐藏成员组";
$lang['group_delete'] = "删除成员组";
$lang['group_delete_check'] = "删除这个成员组";
$lang['submit_group_changes'] = "提交更新";
$lang['reset_group_changes'] = "清除重设";
$lang['No_group_name'] = "您必许指定成员组名称";
$lang['No_group_moderator'] = "您必许指定成员组的管理员";
$lang['No_group_mode'] = "您必须指定成员组状态 (开放/封闭/隐藏)";
$lang['No_group_action'] = '未指定动作';
$lang['delete_group_moderator'] = "删除原有的成员组管理员?";
$lang['delete_moderator_explain'] = "如果您变更了成员组管理员而且勾选这个选项会将原有的成员组管理员从成员组中移除, 如不勾选, 这个会员将成为成员组的普通成员.";
$lang['Click_return_groupsadmin'] = "点击 %s这里%s 返回成员组管理.";
$lang['Select_group'] = "选择成员组";
$lang['Look_up_group'] = "查询成员组";
...
// Mass Email
//
$lang['Mass_email_explain'] = "在这个选项里您可以发送电子邮件讯息给所有的会员或是特定的成员组的成员. 这封电子邮件将被寄送至系统管理员提供的电子邮件信箱, 并以密件副本的方式寄送给所有收件人. 如果收件人数过多, 系统需要较长的时间来执行, 请在提交送出后耐心等候, <b>切勿</b>在程序完成之前停止网页动作.当发送完成时将显示提示.";
$lang['Compose'] = "写邮件";
...
$lang['No_update_ranks'] = '该等级已经成功删除. 但是属于该等级的用户帐号属性并未更新. 你需要手动重设这些帐号的登记属性';
