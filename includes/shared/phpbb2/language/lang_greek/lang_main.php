<?php
/***************************************************************************
 *                            lang_main.php [Greek-Hellenic]
 *                              -------------------
 *     begin                : Sat Dec 16 2000
 *     copyright            : (C) 2001 The phpBB Group
 *     email                : support@phpbb.com
 *
 *     $Id: lang_main.php,v 1.85.2.22 2006/12/16 09:51:02 acydburn Exp $
 *
 ****************************************************************************/
...
/*************************************************************************** 
 *CONTRIBUTOR
	*2008-01-22 by	Alex Xenias (a_xenias@yahoo.gr  http://www.ikaria.gr)
	 *Added new lines, - fixed many grammar problems for version 2.22
****************************************************************************/
...
// please add it here.
$lang['TRANSLATION'] = 'Hellenic (Greek) by <a href="http://www.ikaria.gr" title="Hellenic (Greek) by Alex Xenias...">Alex Xenias</a>';
$lang['TRANSLATION_INFO'] = 'Hellenic (Greek) by <a href="http://www.ikaria.gr" title="Hellenic (Greek) by Alex Xenias...">Alex Xenias</a>';
...
$lang['New_posts_hot'] = 'Υπάρχουν νέες δημοσιεύσεις [ Δημοφιλές ]';
$lang['No_new_posts_locked'] = 'Δεν υπάρχουν νέες δημοσιεύσεις [ Κλειδωμένο ]';
$lang['New_posts_locked'] = 'Υπάρχουν νέες δημοσιεύσεις [ Κλειδωμένο ]';
...
$lang['Avatar_panel'] = 'Πίνακας ελέγχου ʼβαταρ';
$lang['Avatar_gallery'] = 'Φωτοθήκη ʼβαταρ';
...
$lang['Only_one_avatar'] = 'Μόνο ένας τύπος ʼβαταρ μπορεί να ορισθεί';
...
$lang['Wrong_remote_avatar_format'] = 'Η απομακρυσμένη Διεύθυνση του ʼβαταρ δεν είναι ακριβής';
...
$lang['Upload_Avatar_file'] = 'Μεταφορά ʼβαταρ από τον υπολογιστή σας';
$lang['Upload_Avatar_URL'] = 'Μεταφορά ʼβαταρ από URL';
$lang['Upload_Avatar_URL_explain'] = 'Εισαγωγή URL η οποία περιέχει το ʼβαταρ αρχείο, θα γίνει μεταφορά στον εξυπηρετητή μας.';
$lang['Pick_local_Avatar'] = 'Επιλογή ενός ʼβαταρ από την δική μας φωτοθήκη';
$lang['Link_remote_Avatar'] = 'Σύνδεσμος για απομακρυσμένο ʼβαταρ';
$lang['Link_remote_Avatar_explain'] = 'Εισαγωγή URL η οποία περιέχει το ʼβαταρ αρχείο για το οποίο θέλετε να δημιουργήσετε σύνδεσμο.';
$lang['Avatar_URL'] = 'URL ʼβαταρ αρχείου';
$lang['Select_from_gallery'] = 'Επιλογή ενός ʼβαταρ από εικονοθήκη';
$lang['View_avatar_gallery'] = 'Παρουσίαση φωτοθήκης';

$lang['Select_avatar'] = 'Επιλογή ʼβαταρ';
$lang['Return_profile'] = 'Ακύρωση ʼβαταρ';
...
$lang['Avatar_filetype'] = 'Ο τύπος του αρχείου ʼβαταρ πρέπει να είναι .jpg, .gif ή .png';
$lang['Avatar_filesize'] = 'Το μέγεθος του αρχείου ʼβαταρ πρέπει να είναι μικρότερο από %d kB'; // The avatar image file size must be less than 6 KB
$lang['Avatar_imagesize'] = 'Το μέγεθος του ʼβαταρ δεν μπορεί να ξεπερνά τα %d εικονοστοιχεία σε πλάτος και τα %d εικονοστοιχεία σε ύψος'; 
...
//
$lang['Confirm_code_wrong'] = 'Ο κωδικός επιβεβαίωσης που εισάγαται είναι λανθασμένος';
$lang['Too_many_registers'] = 'Ξεπεράσατε το όριο προσπαθειών για εγγραφή. Παρακαλώ δοκιμάστε ξανά αργότερα.';
$lang['Confirm_code_impaired'] = 'Αν έχετε κάποια οπτική ανικανότητα ή για οποιονδήποτε άλλο λόγο δεν μπορείτε να διαβάσετε αυτόν τον κωδικό παρακαλώ επικοινωνήστε με %sAdministrator%s για βοήθεια.';
$lang['Confirm_code'] = 'Κωδικός επιβεβαίωσης';
$lang['Confirm_code_explain'] = 'Εισάγετε τον κωδικό ακριβώς όπως τον βλέπετε. Προσοχή!! Ο κωδικός γράφεται με κεφαλαίους και μικρούς χαρακτήρες, το μηδέν φέρει διαγώνιο γράμμη μέσα του!';
...
$lang['Search_Flood_Error'] = 'Δεν μπορείτε να κάνετε καμία αναζήτηση μετά την τελευταία σας. Παρακαλώ δοκιμάστε σε λίγο.';
...
$lang['Other_IP_this_user'] = 'ʼλλες IP από τις οποίες δημοσίευσε αυτός ο χρήστης';
...
$lang['3.5'] = 'GMT + 3.5 Ώρες';
$lang['4'] = 'GMT + 4 Ώρες';
$lang['4.5'] = 'GMT + 4.5 Ώρες';
$lang['5'] = 'GMT + 5 Ώρες';
$lang['5.5'] = 'GMT + 5.5 Ώρες';
$lang['6'] = 'GMT + 6 Ώρες';
$lang['6.5'] = 'GMT + 6.5 Ώρες';
$lang['7'] = 'GMT + 7 Ώρες';
$lang['8'] = 'GMT + 8 Ώρες';
$lang['9'] = 'GMT + 9 Ώρες';
$lang['9.5'] = 'GMT + 9.5 Ώρες';
$lang['10'] = 'GMT + 10 Ώρες';
$lang['11'] = 'GMT + 11 Ώρες';
$lang['12'] = 'GMT + 12 Ώρες';
$lang['13'] = 'GMT + 13:00 Ώρες';
...
$lang['Please_remove_install_contrib'] = 'Παρακαλώ βεβαιωθείτε ότι διαγράψατε τους φακέλους install/ και contrib/ ';

$lang['Session_invalid'] = 'Λάθος λειτουργία. Παρακαλώ ξανασυμπληρώσυε την φόρμα.';
