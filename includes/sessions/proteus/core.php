...
*
* @package Auth
* @version $Id: core.php,v 3.39 2021/04/02 00:36:53 orynider Exp $
...
class mx_backend
{
	...
	* Credit: https://stackoverflow.com/users/2456038/rafasashi
	 ...
	 * @access private
	 */
	function get_phpbb_info($root_path, $backend = 'proteus', $phpbbversion = '3.3.4')
	{
		$phpEx = substr(strrchr(__FILE__, '.'), 1);
	...
	* Set phpbb config values
	...
	public function obtain_phpbb_config($use_cache = true)
	{
		...
		{		
			...
			{
				global $table_prefix, $mx_root_path;
				if ((@include $mx_root_path."includes/sessions/proteus/constants.$phpEx") === false)
				{
