...
*
* @package Auth
* @version $Id: functions.php,v 1.1 2014/05/18 06:26:59 orynider Exp $
...
{
	global $smf_root_path, $phpEx, $mx_user, $phpbb_auth;
	...
	if ($user_id && $user_id != ANONYMOUS)
	{
		...
		{
			$profile_url = ($custom_profile_url !== false) ? $custom_profile_url : mx3_append_sid("{$smf_root_path}memberlist.$phpEx", 'mode=viewprofile');
