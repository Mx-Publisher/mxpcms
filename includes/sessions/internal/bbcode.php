...
* @version $Id: bbcode.php,v 1.4 2014/05/09 07:52:03 orynider Exp $
...
require($mx_root_path . 'includes/mx_functions_bbcode.' . $phpEx); // BBCode associated functions
...
class mx_bbcode extends bbcode_base
{
	...
	*/	
	function mx_bbcode($bitfield = '')
	{
		...
		$board_config['smilies_path'] = str_replace("smiles", "smilies", $board_config['smilies_path']); //Added by OryNider
