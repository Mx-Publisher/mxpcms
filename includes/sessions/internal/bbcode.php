...
class mx_bbcode extends bbcode_base
{
	...
	*/	
	function __contruct($bitfield = '')
	{
		global $board_config, $mx_root_path, $phpbb_root_path;
		...
		$this->smiley_path_url = PORTAL_URL . 'includes/shared/phpbb2/'; //change this to PORTAL_URL when shared folder will be removed
		$this->smiley_root_path = $mx_root_path . 'includes/shared/phpbb2/'; //same here
		$board_config['smilies_path'] = str_replace("smilies", "smiles", $board_config['smilies_path']); //Added by OryNider
