...
*
* @package Style
* @version $Id: session.php,v 3.2.3 2020/02/25 04:13:02 orynider Exp $
...
class session
{
	...
	function load()
	{
		...
		if (!$this->db->sql_field_exists('group_colour', GROUPS_TABLE))
		{
			...
			$this->db_tools->sql_column_add(GROUPS_TABLE, 'group_colour', array('column_type_sql' => 'varchar(50)', 'null' => 'NOT NULL', 'default' => '000FFF', 'after' => ''), false);
