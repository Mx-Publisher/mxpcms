...
* @version $Id: mx_news_lists.php,v 1.2 2008/06/03 20:12:40 jonohlsson Exp $
 ...
 *
 */
class mx_news_lists extends mx_news_public
{
	/**
	 * Enter description here...
	 *
	...
	function main( $action )
	{
		...
		// Output all
		//
		$this->display( $lang['Links'], 'mx_news_lists.tpl' );
	}
}
?>