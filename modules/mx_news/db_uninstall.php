...
* @version $Id: db_uninstall.php,v 1.2 2008/06/03 20:12:17 jonohlsson Exp $
...
$sql = array(
	"DROP TABLE " . $mx_table_prefix . "simplenews_config ",

	"DROP TABLE " . $mx_table_prefix . "simplenews_comments ",
