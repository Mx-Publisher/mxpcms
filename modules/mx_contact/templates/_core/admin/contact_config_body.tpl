...
<form action="{S_CONFIG_ACTION}" method="post">
 <table width="100%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
	...
	<tr>
		<td width="49%" class="row1"><b>{L_DOMAINKEY_SIG}</b><br /><span class="gensmall">{L_DOMAINKEY_SIG_EXPLAIN}</span></td>
		<td width="49%" class="row2"><input class="post" type="text" size="73" maxlength="200" name="domainkey_signature" value="{DOMAINKEY_SIG}" /></td>
	</tr>
	<tr>
		<td width="49%" class="row1"><b>{L_SMTP_PORT}</b><br /><span class="gensmall">{L_SMTP_PORT_EXPLAIN}</span></td>
		<td width="49%" class="row2"><input class="post" type="text" size="8" maxlength="4" name="smtp_port" value="{SMTP_PORT}" /></td>
	</tr>		
	<tr>
