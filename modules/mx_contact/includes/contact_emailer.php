...
/***************************************************************************
    ...
    $Id: contact_emailer.php,v 1.4 2009/12/15 09:03:46 orynider Exp $
...
class emailer
{
	...
	*/
	...
	function use_template($template_file, $template_lang = '')
	{
		...
		{
			$tpl_file = $module_root_path . 'language/lang_' . $template_lang . '/email/' . $template_file . '.tpl';

			if (!file_exists(realpath($tpl_file)))
			{
				$tpl_file = $module_root_path . 'language/lang_' . $board_config['default_lang'] . '/email/' . $template_file . '.tpl';
	...
	function send()
	{
		global $board_config, $lang, $phpEx, $phpbb_root_path, $db, $module_root_path;
		...
		if ( $this->use_smtp )
		{
			...
			{
				include($module_root_path . 'includes/contact_smtp.' . $phpEx);
			}
