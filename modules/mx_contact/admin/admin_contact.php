...
if ( !empty( $setmodules ) )
{
	...
	$module['Contact_Form']['Configuration'] = 'modules/mx_contact/admin/' . $file;
	return;
}
...
$template->set_filenames(array(
	'body' => 'admin/contact_config_body.'.$tplEx)
);
...
$template->assign_vars(array(
	...
	'L_DOMAINKEY_SIG' => $lang['domainkey_signature'],
	'L_DOMAINKEY_SIG_EXPLAIN' => $lang['domainkey_signature_exp'],
	'L_SMTP_PORT' => $lang['smtp_port'],
	'L_SMTP_PORT_EXPLAIN' => $lang['smtp_port_exp'],	
	...
	'DOMAINKEY_SIG' => $contact_config['domainkey_signature'],	
	'SMTP_PORT' => $contact_config['smtp_port'],	

	'COPYRIGHT' => $lang['Copyright'],

	'S_CONFIG_ACTION' => mx_append_sid("admin_contact.$phpEx"),
