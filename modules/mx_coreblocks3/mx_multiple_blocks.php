...
* @version $Id: mx_multiple_blocks.php,v 1.14 2014/05/18 06:24:56 orynider Exp $
...
for ($cell = 0; $cell < $nested_block_count; $cell++) 
{
	...
	$is_auth_ary = array();
	$is_auth_ary = $mx_block->block_auth(AUTH_VIEW, $inner_block_id , $userdata, $block_row, $block_row[auth_view] );
