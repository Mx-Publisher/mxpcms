			<table cellpadding="0" cellspacing="0" border="0" align="center">
				<tr>
					...
					<td class="nav" align="center" valign="middle">
						<div class="cat-button{catrow.CURRENT}" onmouseout="this.className='cat-button{catrow.CURRENT}';" onmouseover="this.className='cat-button-current';">{catrow.U_MENU_ICON}<a href="{catrow.U_CATEGORY_URL}">{catrow.CATEGORY_NAME}</a></div>
					</td>
					<!-- END catrow -->
				</tr>
			</table>
