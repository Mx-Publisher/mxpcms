...
* @version $Id: db_uninstall.php,v 1.7 2013/05/28 07:14:33 orynider Exp $
...
$sql = array(
	"DROP TABLE ".$mx_table_prefix."shotcast_config",
	"DROP TABLE ".$mx_table_prefix."shotcast_session"
);

$n = 0;
$message = "<b>This list is a result of the SQL queries needed to uninstall shotcast Module Addon</b><br/><br/>";
