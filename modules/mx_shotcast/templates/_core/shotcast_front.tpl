<div class="clear"></div>
<div width="{BLOCK_SIZE}" class="forabg block" style="vertical-align:top;">
...
<table cellpadding="0" cellspacing="1" border="0" class="forumline" style="border:none; padding:4px;">
	<tr>
		<!-- BEGIN switch_listeners_list_on -->
		<td class="row1" align="center" valign="middle" rowspan="3"></td>
