				...
				<!-- BEGIN preview -->
				<tr>
		  			<td class="row1" valign="top" width="25%" align="center" colspan="2">
						<table width="70%" border="0" cellspacing="0" cellpadding="1" class="forumline">
							<tr>
								<th class="cat" align="center" >&nbsp;{L_PREVIEW}&nbsp;</th>
							</tr>
							<tr>
								<td  align="left" ><span class="genmed">{TEXT}</span></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
		  			...
		  			<td class="row1" valign="top" width="80">
						<table width="100%" border="0" cellspacing="0" cellpadding="1">
						  	...
						  	<tr>
						  		<td class="row1" valign="top" align="center"><span class="gen"><b>{L_OPTIONS}</b></span><br /><span class="gensmall">{HTML_STATUS}<br />{BBCODE_STATUS}<br />{SMILIES_STATUS}</span></td>
							</tr>
						</table>

					</td>

					<td class="row2" valign="top" width="100%"><span class="gen">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="2">
						  ...
						  <tr>
							<td colspan="9">
								<span class="gensmall">
							  		<input type="text" name="helpbox" size="40" maxlength="100" style="width:450px; font-size:10px" class="helpline" value="{L_STYLES_TIP}" />
							  	</span>
							</td>
						  </tr>
						  <!-- END switch_bbcodes -->
						...
						<tr>
							<td colspan="9" align="left">
								<span class="gen">
									<textarea name="{SELECT_NAME}" rows="40" cols="35" wrap="virtual" style="width:550px" tabindex="3" class="post" {TEXTAREA_BBCODES_XTRA}>{textblock.TEXT}</textarea>
								</span>
							</td>
						</tr>
				 ...
				 <tr>
					<td colspan="2" class="row1" valign="top" align="center"><span class="gen"><input type="submit" tabindex="5" name="preview" class="mainoption" value="{L_PREVIEW}" /></span></td>
				</tr>