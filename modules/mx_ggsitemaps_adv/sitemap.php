...
* @version $Id: sitemap.php,v 1.3 2011/05/01 22:19:08 orynider Exp $
...
$paths['phpbb_path'] = ($phpbb_root_path) ? preg_replace('/^\/?(.*?)\/?$/', "\\1", trim($phpbb_root_path)) : preg_replace('/^\/?(.*?)\/?$/', "\\1", trim($board_config['script_path']));
