...
* @version $Id: ggs_functions.php,v 1.5 2011/05/01 22:19:08 orynider Exp $
...
class GGSitemaps {
	...
	*/
	function GGs_sitemapindex() {
		global $phpEx, $db, $board_config, $phpbb_seo, $phpbb_auth, $mx_user, $mx_page, $phpbb_root_path, $mx_root_path, $module_root_path;
	...
	*/
	function GGs_sitemap() {
		global $phpEx, $db, $board_config, $portal_config, $phpbb_seo, $phpbb_auth, $mx_user, $mx_page, $phpbb_root_path;
	...
	*/
	function GGs_yahoo() {
		global $phpEx, $db, $board_config, $phpbb_seo, $phpbb_auth, $mx_user, $mx_page, $phpbb_root_path, $mx_root_path;
		// Initialize SQL cycling : do not query for more than required
