...
<table width="100%" border="0" cellpadding="4" cellspacing="1" class="forumline" style="border-top:none;">
	<tr>
		<td align="center" class="row1">
			<!-- IF IS_AUTH_SEARCH -->
			<b>&nbsp;<a href="{U_PASEARCH}" class="gensmall"><img src="{SEARCH_IMG}" border="0" alt="{L_SEARCH}" align="middle" /></a>&nbsp;</b>
			<!-- ENDIF -->
			<!-- IF IS_AUTH_STATS -->
			<b>&nbsp;<a href="{U_PASTATS}" class="gensmall"><img src="{STATS_IMG}" border="0" alt="{L_STATS}" align="middle" /></a>&nbsp;</b>
			<!-- ENDIF -->
			<!-- IF IS_AUTH_TOPLIST -->
			<b>&nbsp;<a href="{U_TOPLIST}" class="gensmall"><img src="{TOPLIST_IMG}" border="0" alt="{L_TOPLIST}" align="middle" /></a>&nbsp;</b>
			<!-- ENDIF -->
			<!-- IF IS_AUTH_UPLOAD -->
			<b>&nbsp;<a href="{U_UPLOAD}" class="gensmall"><img src="{UPLOAD_IMG}" border="0" alt="{L_UPLOAD}" align="middle" /></a>&nbsp;</b>
			<!-- ENDIF -->
			<!-- IF IS_AUTH_VIEWALL -->
			...
			<br />
			<!-- IF IS_AUTH_MCP -->
			<b>&nbsp;<a href="{U_MCP}" class="gensmall">[{MCP_LINK}]</a>&nbsp;</b>
			<!-- ENDIF -->
		</td>
	</tr>
</table>
