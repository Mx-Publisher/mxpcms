...
<!-- ENDIF -->
<!-- IF AUTH_DELETE -->
		<a href="javascript:delete_item('{U_DELETE}')"><img src="{DELETE_IMG}" border="0" alt="{L_DELETE}" /></a>
<!-- ENDIF -->
	</th>
  </tr>
<tr>
...
<!-- BEGIN use_ratings -->
	<td width="34%" align="center"><a href="{use_ratings.U_RATE}"><img src="{use_ratings.RATE_IMG}" border="0" alt="{use_ratings.L_RATE}" /></a></td>
<!-- END use_ratings -->
