...
* @version $Id: pa_search.php,v 1.30 2010/01/06 20:27:15 orynider Exp $
	...
	function main( $action  = false )
	{
		...
		if ( isset( $_POST['submit'] ) || $search_author != '' || $search_keywords != '' || $search_id )
		{
			...
			if ( $search_results != '' )
			{
				...
				$template->assign_vars( array(
					...
					'PAGE_NUMBER' => sprintf( $lang['Page_of'], ( floor( $start / $pafiledb_config['pagination'] ) + 1 ), ceil( $total_match_count / $pafiledb_config['pagination'] ) ),
		...
		if ( !isset( $_POST['submit'] ) || ( $search_author == '' && $search_keywords == '' && !$search_id ) )
		{
			...
			$template->assign_vars( array(
				...
				'L_DOWNLOADS' => $lang['Most_downloads'],
