...
* @version $Id: pa_mcp.php,v 1.20 2008/09/21 14:25:33 orynider Exp $
...
class pafiledb_mcp extends pafiledb_public
{
	...
	function main( $action  = false )
	{
		...
		global $pafiledb_functions, $template, $pafiledb_config;
		...
		if ( in_array( $mode, array( 'unapproved', 'broken', 'cat', 'all' ) ) )
		{
			...
			$template->assign_vars( array(
				...
				'PAGE_NUMBER' => sprintf( $lang['Page_of'], ( floor( $start / $pafiledb_config['pagination'] ) + 1 ), ceil( $total_num / $pafiledb_config['pagination'] ) ),
