...
* @version $Id: pa_rate.php,v 1.22 2008/09/21 14:25:36 orynider Exp $
...
class pafiledb_rate extends pafiledb_public
{
	...
	{
		global $template, $lang, $board_config, $phpEx, $pafiledb_config, $db, $userdata;
		global $phpbb_root_path, $pafiledb_user, $pafiledb_functions;
