...
class pafiledb_comments extends mx_comments
{
	...
	{
		global $pafiledb, $mx_user, $pafiledb_config, $db, $images;
		...
		$images['pa_icon_minipost'] = $mx_user->img('icon_post_target', '', false, '', 'src');
		$images['pa_icon_latest_reply'] = $mx_user->img('icon_topic_latest', '', false, '', 'src');
		$images['pa_icon_newest_reply'] = $mx_user->img('icon_newest_reply', '', false, '', 'src');		
