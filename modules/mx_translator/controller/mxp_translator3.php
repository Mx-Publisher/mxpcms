		...
		switch ($which_list)
		{
			...
			case 'files':
				switch($this->s)
				{
					...
					break;					
					case 'MODS':
						$list_ary = @isset($this->module_select) ? @print_r($this->language_dir_list[$this->module_select], true) : '';
					break;
					case 'phpbb_ext':
						$list_ary = @isset($this->language_file_list[str_replace('//', '', $this->module_select)]) ? $this->language_file_list[str_replace('//', '', $this->module_select)] : str_replace('//', '', $this->module_select);
					break;					
				}
			break;
			case 'dirs':
