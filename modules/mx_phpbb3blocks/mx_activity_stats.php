...
* @version $Id: mx_activity_stats.php,v 1.1 2008/10/04 07:04:38 orynider Exp $
...
include_once( $module_root_path . 'includes/mx_functions_activity.' . $phpEx );
...
$template->set_filenames(array(
	'block_forum' => 'mx_activity_stats.html')
);
