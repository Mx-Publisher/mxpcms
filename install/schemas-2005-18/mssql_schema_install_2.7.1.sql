...
CREATE TABLE mx_table_block_parameter (
    ...
    CONSTRAINT mx_table_block_parameter_pk PRIMARY KEY (block_id, parameter_id) ON [PRIMARY],
    CHECK (block_id>=0),
    CHECK (parameter_id>=0)
)  ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];

INSERT INTO mx_table_block_parameter VALUES(1,15,'Welcome to the mx-publisher Portal!\r\n\r\nPlease visit www.mx-publisher.com for further information.\r\n\r\nThe Mx-Portal version is announced and documented [url=http://mxpcms.sourceforge.net/forum/viewforum.php?f=11] here[/url].','10bec5b560');

INSERT INTO mx_table_block_parameter VALUES(2,60,'3,4,5','');

INSERT INTO mx_table_block_parameter VALUES(2,61,'33%,*,33%','');

INSERT INTO mx_table_block_parameter VALUES(2,62,'4','');

INSERT INTO mx_table_block_parameter VALUES(3,50,'This is a demo multi textblock!\r\n\r\n - featuring bbcode, html (if allowed by phpbb config), style parameters (click the EDIT button and try them out) and permissions (view and edit permissions for users and PRIVATE groups).','10bec5b560');

INSERT INTO mx_table_block_parameter VALUES(3,51,'none','');

INSERT INTO mx_table_block_parameter VALUES(3,52,'TRUE','');

INSERT INTO mx_table_block_parameter VALUES(3,53,'TRUE','');

INSERT INTO mx_table_block_parameter VALUES(3,54,'TRUE','');

INSERT INTO mx_table_block_parameter VALUES(4,15,'This is a demo bbcode textblock!\r\n\r\n- featuring bbcode, html (if allowed by phpbb config) and permissions (view and edit permissions for users and PRIVATE groups).','10bec5b560');

INSERT INTO mx_table_block_parameter VALUES(5,16,'This is a demo html textblock!\r\n\r\n- featuring html (if allowed by phpbb config) and permissions (view and edit permissions for users and PRIVATE groups).','10bec5b560');

INSERT INTO mx_table_block_parameter VALUES(6,36,'',NULL);

INSERT INTO mx_table_block_parameter VALUES(6,13,'0',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,17,'5',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,18,'TRUE',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,19,'30',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,20,'_self',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,21,'left',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,22,'TRUE',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,37,'',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,38,'FALSE',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,39,'FALSE',NULL);

INSERT INTO mx_table_block_parameter VALUES(16,40,'TRUE',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,1,'1',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,2,'999',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,3,'TRUE',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,4,'FALSE',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,5,'FALSE',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,7,'thumb_news.gif',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,8,'thumb_globe.gif',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,9,'thumb_globe.gif',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,6,'TRUE',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,10,'thumb_globe.gif ',NULL);

INSERT INTO mx_table_block_parameter VALUES(18,11,'',NULL);
