...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{BACKEND_URL}Themes/default/css/index.css?fin20" />
	<link rel="stylesheet" type="text/css" href="{BACKEND_URL}Themes/default/css/install.css?fin20" />
	<script type="text/javascript" src="{BACKEND_URL}Themes/default/scripts/script.js"></script>
	<style type="text/css">
	<!--
	/*
