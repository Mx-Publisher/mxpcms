#
# mxBB-Portal - MySQL Schema - Upgrade "2.705"
#
# $Id: mysql_schema_upgrade_to_2.705.sql,v 1.1 2005/03/20 03:37:05 markus_petrux Exp $
#

# ------------------------------------------------------------
#
# Remove auto_increment attribute from field parameter_id
