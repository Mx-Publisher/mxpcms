#
# mxBB-Portal - MySQL Schema - Upgrade "2.7.1"
#
# $Id: mysql_schema_upgrade_to_2.7.1.sql,v 1.1 2005/03/06 01:18:56 jonohlsson Exp $
#
...
#
DROP TABLE IF EXISTS mx_table_block_user_parameter;

# ------------------------------------------------------------
#
# New Fields in Table `mx_page`
#
ALTER TABLE mx_table_page ADD page_header VARCHAR(255) DEFAULT 'overall_header.tpl' NULL;

# ------------------------------------------------------------
#
# New Fields in Table `mx_menu_nav`
#
ALTER TABLE mx_table_menu_nav ADD link_target TINYINT(2) UNSIGNED NOT NULL DEFAULT '0';
