...
#
# $Id: mysql_schema_upgrade_to_2.8.1.sql,v 1.6 2008/02/04 15:58:07 joasch Exp $
#
...
ALTER TABLE mx_table_portal ADD disabled_message varchar(255) default 'We are currently upgrading this site with latest MX-Publisher software.' AFTER portal_status;
