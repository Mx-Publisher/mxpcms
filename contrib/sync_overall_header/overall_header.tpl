	...
	<tr> 
 		<td class="bodyline">
		  ...
		  <table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr> 
 				<td align="left" valign="top" width="25%"><a href="{U_INDEX_PORTAL}"><img src="{MX_ROOT_PATH}/{TEMPLATE_ROOT_PATH}/images/banner_mx-publisher.gif" border="0" alt="{L_INDEX}" vspace="1"/></a><br /><span class="genmed"><b>{SITENAME}</b></span><br /><span style="font-size: 5pt;">{SITE_DESCRIPTION}<br />&nbsp; </span></td>
