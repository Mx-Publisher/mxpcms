...
//
$page_id = $mx_request_vars->request('page_id', MX_TYPE_INT, 1);
...
{
  global $template, $mx_user, $lang, $db, $board_config, $theme, $mx_root_path , $mx_backend, $phpEx;
...
{
  global $template, $lang, $db, $board_config, $theme, $HTTP_POST_VARS, $mx_cache, $mx_user, $mx_request_vars, $mx_root_path , $mx_backend, $phpEx;
...
{
  global $template, $mx_user, $lang, $db, $board_config, $theme, $HTTP_POST_VARS, $mx_root_path , $mx_backend, $phpEx;
