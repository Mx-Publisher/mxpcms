...
$lang['Install_Instruction_phpBB']	= 'Va rugam sa luati seama, chiar daca aveti de gand sa folositi MX-Publisher cu phpBB, aceasta instalare nu va modifica baza de date phpBB in nici un fel. Pentru mai multe ';
