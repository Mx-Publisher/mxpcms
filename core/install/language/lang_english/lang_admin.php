...
$lang['Install_Instruction_phpBB'] = 'Please note, even if you plan to use MX-Publisher with phpBB2, this installation does not modify your phpBB2 database in any way.';
...
$lang['Session_backend_explain'] = 'The MX-Publisher-IWizard has detected installed phpBB2 boards on this server. <br />Select here if you plan to use MX-Publisher with phpBB users and sessions. <br />If you are unsure (or if you want to install MX-Publisher without phpBB), select \'Internal\' setup. <br />You may update this setting later in the MX-Publisher adminCP';
