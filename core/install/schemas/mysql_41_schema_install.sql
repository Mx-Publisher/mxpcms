...
#
# Host: localhost   Database: core 2.7.8
#--------------------------------------------------------
...
CREATE TABLE `mx_table_block` (
  ...
  `auth_moderator_group` smallint(5) NOT NULL default '0',
...
INSERT INTO mx_table_block_system_parameter VALUES("28", "15", "[b:5093963b57]mxBB-Portal[/b:5093963b57] is a fully modular portal and CMS for phpBB, featuring dynamic pages, blocks, themes, and more by means of a powerful yet flexible AdminCP. It works without touching phpBB by using integrated features and functions.  mxBB-Portal requires phpBB to run, and currently supports the mySQL and postgreSQL databases, with planned support for MS-SQL and other DBMSs. mxBB-Portal is the classical phpBB portal add-on, improved and enhanced for every phpBB version released since 2001.\r\n\r\n[i:5093963b57]Welcome, and thanks for using the mxBB-Portal![/i:5093963b57] \r\n\r\n :lol:", "5093963b57", "0");
...
INSERT INTO mx_table_menu_nav VALUES("4", "1", "MX-Portal Home", "", "http://mxpcms.sourceforge.net/", "0", "10", "1f171544ea", "icon_info.gif", "", "", "0", "0", "0", "0", "1");
...
#
INSERT INTO mx_table_module VALUES("10", "Core Blocks", "modules/mx_coreblocks/", "mxBB Core (standard) Module", "0", "", "mxBB Core Module");
INSERT INTO mx_table_module VALUES("20", "Text Blocks", "modules/mx_textblocks/", "mxBB Textblocks Module", "0", NULL, "mxBB Core Module");
...
INSERT INTO mx_table_module VALUES("40", "Statistics MX", "modules/mx_statistics/", "mxBB Statistics Module", "0", NULL, "mxBB Core Module");
INSERT INTO mx_table_module VALUES("50", "Navigation Menu", "modules/mx_navmenu/", "mxBB Navigation Module", "0", NULL, "mxBB Core Module");
...
CREATE TABLE `mx_table_page` (
  ...
  `page_footer` varchar(255) default 'overall_footer.tpl',  
...
#
INSERT INTO mx_table_page VALUES("5", "Site Search", "Site Search page", "nav_search.gif", "0", "0", "0", "-1", "-1", "overall_header.tpl", "overall_footer.tpl", "", "0", "a:1:{i:0;s:0:\"\";}", "-1");
INSERT INTO mx_table_page VALUES("4", "Sitestats", "Sitestats page", "nav_statistics.gif", "0", "0", "0", "-1", "-1", "overall_header.tpl", "overall_footer.tpl", "", "0", "a:1:{i:0;s:0:\"\";}", "-1");
INSERT INTO mx_table_page VALUES("1", "Home", "This is the startpage", "nav_home.gif", "0", "0", "0", "-1", "-1", "overall_header.tpl", "overall_footer.tpl", "", "0", "a:1:{i:0;s:0:\"\";}", "-1");
INSERT INTO mx_table_page VALUES("2", "Forum", "This is the phpBB Forum startpage", "nav_forum.gif", "0", "0", "0", "-1", "-1", "overall_header.tpl", "overall_footer.tpl", "", "0", "a:1:{i:0;s:0:\"\";}", "1");
INSERT INTO mx_table_page VALUES("3", "Demo Page", "Block Demos", "nav_develope.gif", "0", "0", "0", "-1", "-1", "overall_header.tpl", "overall_footer.tpl", "", "0", "a:1:{i:0;s:0:\"\";}", "-1");
...
INSERT INTO mx_table_parameter VALUES("60", "11", "block_ids", "Function", "1,2,3", "get_list_multiple( \"{parameter_id}[]\", BLOCK_TABLE, \'block_id\', \'block_title\', \"{parameter_value}\", TRUE)", "0", "0");
...
INSERT INTO mx_table_parameter VALUES("72", "5", "x_1", "Text", "", "", "0", "0");
...
INSERT INTO mx_table_parameter VALUES("71", "5", "x_3", "Text", "http://localhost", "", "0", "0");
...
INSERT INTO mx_table_parameter VALUES("65", "51", "msg_filter_date", "Function", "5", "get_list_static(\"{parameter_id}[]\",array(\"no limit\", \"1 day\", \"2 days\", \"3 days\", \"1 week\", \"2 weeks\", \"3 weeks\", \"1 month\", \"2 months\", \"3 months\", \"6 months\", \"1 year\"),\"{parameter_value}\")", "0", "0");
...
INSERT INTO mx_table_parameter VALUES("55", "22", "html_tags", "Text", "b,i,u,img", "", "1", "0");
...
CREATE TABLE `mx_table_portal` (
  ...
  `portal_phpbb_url` varchar(255) default 'http://localhost/phpBB/',
  ...
  `disabled_message` varchar(255) default 'We are currenty upgrading this site with latest software.',
