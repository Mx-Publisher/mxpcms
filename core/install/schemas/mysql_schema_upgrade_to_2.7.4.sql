...
SET parameter.next_id = parameter.next_id + 1;
INSERT INTO mx_table_parameter VALUES('{parameter.next_id}', '{function.next_id}', 'include_url', 'Text', 'http://mxpcms.sourceforge.net', '');
INSERT INTO mx_table_block_system_parameter VALUES('{block.next_id}', '{parameter.next_id}', 'http://mxpcms.sourceforge.net', '', '0');
