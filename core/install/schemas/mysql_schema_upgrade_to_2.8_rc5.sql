...
#
# $Id: mysql_schema_upgrade_to_2.8_rc5.sql,v 1.3 2010/10/16 04:06:19 orynider Exp $
#
...
SET function = SELECT * FROM mx_table_function WHERE function_file = 'mx_textblock_blog.php';

UPDATE mx_table_function
	SET function_name = 'TextBlock (Blog)',
		function_desc = 'UserBlog Textblock',
		function_admin = ''
	WHERE function_id = '{function.function_id}';
...
UPDATE mx_table_module
	SET module_name = 'Core Blocks',
	 	module_desc = 'MX-Portal Core (standard) Module',
