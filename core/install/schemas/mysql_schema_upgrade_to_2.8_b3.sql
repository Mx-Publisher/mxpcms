#
# mxBB-Portal - MySQL Schema - Upgrade "2.8.0 - b3"
#
# $Id: mysql_schema_upgrade_to_2.8_b3.sql,v 1.2 2009/01/24 16:47:53 orynider Exp $
#
...
UPDATE mx_table_module
	SET module_name  = 'phpBB2 blocks',
	 	...
	 	module_copy  = 'Original mxBB <i>phpBB2 Blocks</i> module by <a href=\"http://mxpcms.sourceforge.net\" target=\"_blank\"> The mxBB Development Team</a>'
