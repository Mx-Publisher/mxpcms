#
# mxBB-Portal - MySQL Schema - Upgrade "2.8 - RC7"
#
# $Id: mysql_schema_upgrade_to_2.8_rc7.sql,v 1.3 2010/10/16 04:06:19 orynider Exp $
#
...
ALTER TABLE mx_table_block MODIFY auth_view_group smallint(5) NOT NULL default '0';
ALTER TABLE mx_table_block MODIFY auth_edit_group smallint(5) NOT NULL default '0';
ALTER TABLE mx_table_block MODIFY auth_delete_group smallint(5) NOT NULL default '0';
ALTER TABLE mx_table_block MODIFY auth_moderator_group smallint(5) NOT NULL default '0';
...
ALTER TABLE mx_table_page MODIFY auth_view_group smallint(5) NOT NULL default '0';
ALTER TABLE mx_table_page MODIFY auth_moderator_group smallint(5) NOT NULL default '0';
...
#
ALTER TABLE mx_table_parameter ADD parameter_auth tinyint(2) NOT NULL default '0';
