...
<table cellpadding="2" cellspacing="1" border="0">
	...
	<tr>
		<td class="row1" align="right" width="50%"><span class="gen"><b>&nbsp;</b></span><br /><span class="gensmall">{L_PHPBB_PATH}:&nbsp;</span></td>
		<td class="row2">{S_BACKEND_PATH}</td>
	</tr>
	<!-- END switch_readonly_mode -->	
	<tr>
		<td class="row1" align="right" width="50%"><span class="gen"><b></b></span></td>
