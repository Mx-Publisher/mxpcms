<?php
   ...
   *
   *   $Id: postgres7.php,v 1.3 2010/10/16 04:06:19 orynider Exp $
   *
   ***************************************************************************/
...
define("SQL_LAYER_postgres","postgresql");

class sql_db_postgres
{
	...
	// Constructor
	//
	function sql_db_postgres($sqlserver, $sqluser, $sqlpassword, $database, $persistency = true)
	{
		$this->connect_string = "";
