...
*
* @package Tools
* @version $Id: mx_functions_tools.php,v 1.3 2010/10/09 21:28:10 orynider Exp $
...
class mx_text
{
	...
	function init($html_on = false, $bbcode_on = true, $smilies_on = false, $links_on = true, $images_on = true)
	{
		...
		//
		obtain_word_list($this->orig_word, $this->replacement_word);
...
class mx_comments extends phpbb_posts
{
	...
	function u_post()
	{
		return mx_append_sid($this->u_post);
	}
	...
	function u_edit($cid)
	{
		return mx_append_sid($this->u_edit . '&cid='.$cid );
	}
	...
	{
		return mx_append_sid($this->u_delete . '&cid='.$cid);
	}
	...
	{
		return $this->u_pagination . $page_num;
	}
	...
	{
		global $template, $lang, $board_config, $phpEx, $db, $userdata, $images;
	...
	{
		global $template, $lang, $board_config, $phpEx, $db, $mx_user, $userdata, $images;
		global $mx_root_path, $module_root_path, $phpbb_root_path, $is_block, $phpEx, $mx_request_vars, $portal_config;
