...
class mx_admin
{
	...
	{
		global $template, $lang, $db, $board_config, $theme, $phpEx, $_GET, $_POST, $userdata, $mx_request_vars, $mx_cache;
		...
		switch ( $type )
		{
			...
			case MX_PAGE_TEMPLATE_COLUMN_TYPE:
				...
				$message = $lang['AdminCP_action'] . ": " . $lang['Page_template_column'] . ' (' . htmlspecialchars(trim($_POST['column_title'])) . ') ' . $lang['was_inserted'];
	...
	{
		global $template, $lang, $db, $board_config, $theme, $phpEx, $_GET, $_POST, $mx_request_vars, $mx_cache, $mx_root_path, $mx_table_prefix, $table_prefix, $userdata;
		...
		switch ( $type )
		{
			...
			case MX_PAGE_BLOCK_TYPE:
				...
				else
				{
					...
					$block_id = intval($id);
					$column_id = ( isset($_POST['column_id']) ) ? intval($_POST['column_id']) : intval($_GET['column_id']);
					$block_order = ( isset($_POST['block_order']) ) ? intval($_POST['block_order']) : intval($_GET['block_order']);
	...
	{
		global $template, $lang, $db, $board_config, $theme, $phpEx, $_GET, $_POST, $mx_request_vars, $mx_cache;
	...
	{
		global $template, $lang, $db, $board_config, $theme, $phpEx, $_GET, $_POST;
		...
		switch ( $type )
		{
			case MX_PAGE_BLOCK_TYPE:
				...
				if ( !MX_ADMIN_DEBUG )
				{
					...
					sync('block', intval($_GET[block_id]));
					$show_index = true;
	...
	{
		global $template, $lang, $db, $board_config, $theme, $phpEx, $_GET, $_POST, $mx_request_vars;
	...
	{
		global $template, $lang, $db, $board_config, $theme, $_POST, $delimeter;
	...
	{
		global $table_prefix, $mx_table_prefix, $userdata, $phpEx, $template, $lang, $db, $board_config, $theme, $_POST, $delimeter, $mx_root_path;
...
{
	global $table_prefix, $mx_table_prefix, $userdata, $phpEx, $template, $lang, $db, $board_config, $theme, $_POST, $delimeter;
