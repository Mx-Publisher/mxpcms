...
class bbcode_base
{
	...
	function prepare_bbcode_template($bbcode_tpl)
	{
		...
		$bbcode_tpl['spoil_open'] = !isset($bbcode_tpl['spoil_open']) ? 'spoil_open' : $bbcode_tpl['spoil_open'];
	 	...
	 	$bbcode_tpl['ram'] = !isset($bbcode_tpl['ram']) ? 'ram' : $bbcode_tpl['ram'];
	 	...
	 	$bbcode_tpl['table_open'] = !isset($bbcode_tpl['table_open']) ? 'table_open' : $bbcode_tpl['table_open'];	 	
	 	$bbcode_tpl['table_close'] = !isset($bbcode_tpl['table_close']) ? 'table_close' : $bbcode_tpl['table_close'];	 		 	
		$bbcode_tpl['cell_open'] = !isset($bbcode_tpl['cell_open']) ? 'cell_open' : $bbcode_tpl['cell_open'];		
	 	$bbcode_tpl['cell_close'] = !isset($bbcode_tpl['cell_close']) ? 'cell_close' : $bbcode_tpl['cell_close'];				
		...
		$bbcode_tpl['ipaper_open'] = !isset($bbcode_tpl['ipaper_open']) ? 'ipaper_open' : $bbcode_tpl['ipaper_open'];		
	 	$bbcode_tpl['ipaper_close'] = !isset($bbcode_tpl['ipaper_close']) ? 'ipaper_close' : $bbcode_tpl['ipaper_close'];				
		
		$bbcode_tpl['center_open'] = !isset($bbcode_tpl['center_open']) ? 'center_open' : $bbcode_tpl['center_open'];		
	 	$bbcode_tpl['center_close'] = !isset($bbcode_tpl['center_close']) ? 'center_close' : $bbcode_tpl['center_close'];				
	 	$bbcode_tpl['center_close'] = !isset($bbcode_tpl['center_close']) ? 'center_close' : $bbcode_tpl['center_close'];				
						
	 	$bbcode_tpl['poet_open'] = !isset($bbcode_tpl['poet_open']) ? 'poet_open' : $bbcode_tpl['poet_open'];
	 	$bbcode_tpl['poet_close'] = !isset($bbcode_tpl['poet_oclose']) ? 'poet_close' : $bbcode_tpl['poet_close'];
	...
	*/
	...
	function bbencode_first_pass($text, $uid)
	{
		...
		// [img]image_url_here[/img] code..
		if (is_callable("'[img:$uid]\\1' . str_replace(' ', '%20', '\\3') . '[/img:$uid]'"))
		{
