...
*
* @package Style
* @version $Id: session.php,v 1.7 2013/09/04 04:32:35 orynider Exp $
...
class session
{
	...
	*/
	...
	{
		global $mx_user, $mx_cache, $phpbb_auth, $mx_root_path;
		global $mx_request_vars, $portal_config; //added  or fixed for mxp
	...
	function set_lang(&$lang, &$help, $lang_file, $use_db = false, $use_help = false)
	{
		...
		if (!$use_db)
		{
			...
			if ((@include $language_filename) === false)
			{
				...
				{
					die('Language file (set_lang) ' . $language_filename . ' couldn\'t be opened by set_lang().');
				}
			}
		}
		else
