...
*
* @package CH
* @version $Id: mx_functions_ch.php,v 1.2 2009/01/24 16:47:51 orynider Exp $
...
{
	mx_message_die(GENERAL_MESSAGE, 'Please ensure the install_cat/ directory is deleted');
}
