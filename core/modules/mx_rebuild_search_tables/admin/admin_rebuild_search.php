 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: admin_rebuild_search.php,v 1.3 2010/10/16 04:07:57 orynider Exp $
 */
...
if (isset ($HTTP_GET_VARS['start'])) 
{
	...
	{
		$form_action = mx_append_sid ("admin_rebuild_search.$phpEx?start=". ($start + $num_rows) ."&total_num_rows=$total_num_rows&post_limit=". $HTTP_GET_VARS['post_limit'] ."&time_limit=$time_limit&refresh_rate=". $HTTP_GET_VARS['refresh_rate']);
		$next = $lang['Next'];
