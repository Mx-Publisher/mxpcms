...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post"><table width="98%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
	  <td class="row1"><span class="gen">{L_USER_ADMIN}</span></td>
	  <td class="row2">
		<input type="radio" name="user_admin" value="1" {USER_ADMIN_YES} />
		<span class="gen">{L_YES}</span>&nbsp;&nbsp;
		<input type="radio" name="user_admin" value="0" {USER_ADMIN_NO} />
		<span class="gen">{L_NO}</span></td>
	</tr>
	<!--
	<tr>
