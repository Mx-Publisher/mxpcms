<table width="{BLOCK_SIZE}" cellpadding="4" cellspacing="0" border="0" class="forumline">
  <tr>
	...
	<!-- BEGIN msg_row -->
		<tr>
      <td class="row2"  align="center"><span class="cattitle"><img src="{U_PHPBB_ROOT_PATH}{msg_row.FOLDER_IMG}" width="19" height="18" alt="{msg_row.L_TOPIC_FOLDER_ALT}" title="{msg_row.L_TOPIC_FOLDER_ALT}" /></span></td>
