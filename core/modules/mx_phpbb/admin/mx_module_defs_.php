...
* @version $Id: mx_module_defs_.php,v 1.2 2010/10/16 04:07:43 orynider Exp $
...
class mx_module_defs
{
	...
	//To Do
	//This function need to be totaly rewriten
		...
		//{
			...
			if ($total_forums = count($forums))
			{
				...
				for( $j = 0; $j < $total_forums; $j++ )
				{
					...
					{
						$template->assign_block_vars( 'catrow.forumrow_phpbb', array( 'FORUM_ID' => $forums[$j]['forum_id'],
								'FORUM_NAME' => $forums[$j]['forum_name'],
								'FORUM_DESC' => $forums[$j]['forum_desc'],
