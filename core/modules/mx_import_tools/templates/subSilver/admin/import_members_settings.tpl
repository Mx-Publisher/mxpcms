...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
	...
	<tr>
		<td class="row1">
			{L_CSV_LIST}:<br /><span class="gensmall">{L_CSV_LIST_EXPLAIN}</span>
		</td>
		<td class="row2" colspan="2" align="center">{CSV_LIST}</td>
	</tr>
	<tr>
		<td class="row1">
			{L_GROUP_LIST}:<br /><span class="gensmall">{L_GROUP_LIST_EXPLAIN}</span>
		</td>
		<td class="row2" colspan="2" align="center">{GROUP_LIST} <br />
			<input type="radio" name="add_to_group" value="" selected="selected" />
			{L_NO} <input type="radio" name="add_to_group" value="yes" />{L_YES}
		</td>
	</tr>
	<tr>
		<td class="row1">
	...
	<tr>
		<td class="cat" colspan="2" align="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_START_IMPORT}" class="mainoption" /></td>
	</tr>
</table>
</form>
<br />