...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline" style="border-top:none;">
    <tr>
        ...
        <div id="bar">
		    ...
		    <tr>
		        <td>
		            <a class="button" href="javascript:void(0)">{catrow.CATEGORY_NAME}<img class="arrow" src="{MX_ROOT_PATH}modules/mx_navmenu/templates/subSilver/images/arrow_right.gif" width="10" height="12" alt="" /></a>
		            <div class="section">
		            	<!-- BEGIN modulerow -->
		                <a class="item" href="{catrow.modulerow.U_MENU_MODULE}" target="{catrow.modulerow.U_LINK_TARGET}">{catrow.modulerow.U_MENU_ICON}{catrow.modulerow.MENU_NAME}</a>
		                <!-- END modulerow -->
		            </div>
		        </td>
		    </tr>
