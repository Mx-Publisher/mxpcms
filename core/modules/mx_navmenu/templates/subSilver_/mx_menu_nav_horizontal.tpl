				...
				<tr>
					<td class="row1" style="border:none;">
						<table width="100%" cellpadding="2" cellspacing="0" border="0">				
							...
							<!-- BEGIN modulerow -->
							<tr>
								<td style="border:none;" class="row1" valign="center" colspan="2" onmouseout="this.className='row1';" onmouseover="this.className='row2';" onclick="window.location.href='{catrow.modulerow.U_MENU_MODULE}';">{catrow.modulerow.U_MENU_ICON}<span class="{catrow.modulerow.MENU_STYLE}"><a href="{catrow.modulerow.U_MENU_MODULE}" target="{catrow.modulerow.U_LINK_TARGET}" class="genmed" title="{catrow.modulerow.MENU_DESC}">{catrow.modulerow.MENU_NAME}</a></span></td>
							</tr>
							<!-- END modulerow -->
