...
<table width="100%" cellpadding="0" cellspacing="1" border="0" class="forumline" style="border-top:none;">
    <tr>
        <td align="center" class="row1">
			...
			<table width="100%" cellspacing="0" cellpadding="0" id="menu{MENU_ID}" class="ddm1">
			<!-- BEGIN catrow -->
		    <tr>
		        <td>
		            <a class="item1" href="{catrow.CATEGORY_URL}">{catrow.CATEGORY_NAME}<img src="{MX_ROOT_PATH}modules/mx_navmenu/templates/subSilver/images/arrow_right.gif" width="10" height="12" alt="" /></a>
		            <div class="section">
		            	<!-- BEGIN modulerow -->
		                <a class="item2" href="{catrow.modulerow.U_MENU_MODULE}" target="{catrow.modulerow.U_LINK_TARGET}">{catrow.modulerow.U_MENU_ICON}{catrow.modulerow.MENU_NAME}</a>
		                <!-- END modulerow -->
		            </div>
		        </td>
		    </tr>
