...
* @version $Id: simpledoc_view_plain.php,v 1.3 2008/06/03 20:14:13 jonohlsson Exp $
...
class mx_simpledoc_view_plain extends mx_simpledoc_public
{
	function main( $action )
	{
		...
		$template->set_filenames( array( 'body' => 'simpledoc_view_plain.tpl' ));
