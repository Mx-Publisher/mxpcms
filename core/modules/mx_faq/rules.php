 ...
 *
 *   $Id: rules.php,v 1.5 2008/02/09 00:00:45 jonohlsson Exp $
 *
 *
 ***************************************************************************/
...
//
include( $module_root_path.'language/lang_'.$board_config['default_lang'].'/lang_rules.'.$phpEx );
...
//+MOD: DHTML Collapsible FAQ MOD
	'body' => (isset($HTTP_GET_VARS['dhtml']) && $HTTP_GET_VARS['dhtml'] == 'no' ? 'rules_body.tpl' : 'rules_dhtml.tpl'))
//-MOD: DHTML Collapsible FAQ MOD
);
