...
<table class="forumline" width="100%" cellspacing="0" cellpadding="3" border="0" align="center" style="border-top:none;">
<!-- BEGIN faq_block -->
	<tr>
		<td class="catHead" height="28" align="center"><span class="nav">{faq_block.BLOCK_TITLE}</span></td>
	</tr>
	<!-- BEGIN faq_row -->
	<tr>
