...
* @version $Id: lang_xs.php,v 1.3 2010/10/16 04:08:44 orynider Exp $
* @copyright (c) 2002-2006 [Vjacheslav Trushkin, OryNider] mxBB Project Team
...
$lang['xs_title'] = 'eXtreme Styles module';
...
* frame_top.tpl
*/
$lang['xs_menu_lc'] = 'extreme styles module menu';
...
$lang['xs_main_comment1'] = 'This is the eXtreme Styles module main menu. There are quite a few functions within this interface, so this page is here as a guide. There is a short explanation of every function below the function name.<br /><br />Note: This module replaces the phpBB styles management. You will find the default phpBB functions in this list, but these functions are now optimized and have extra features.<br /><br />If you have any questions please visit <a href="http://www.stsoftware.biz/forum" target="_blank">support forum</a> where you can get assistance for this module.';
$lang['xs_main_comment2'] = 'The eXtreme Styles module allows an admin to store entire styles in .style files. Styles are stored in a small compressed file and by doing so this saves the trouble of downloading/uploading many files. Style files are compressed so download/upload is much more efficient than downloading/uploading usual style files.';
$lang['xs_main_comment3'] = 'All functions of phpBB styles management are replaced with eXtreme Styles module.<br /><br /><a href="{URL}">Click here</a> to see menu.';
...
$lang['xs_check_for_updates_explain'] = 'This feature allows you to check for updated versions of styles and modules installed on your forum.';
...
$lang['xs_ftp_log_nochmodule'] = 'warning: cannot chmodule file {FILE}';
$lang['xs_ftp_log_chmodule'] = 'chmodule file {FILE} to {moduleE}';
...
$lang['xs_config_maintitle'] = 'eXtreme Styles module Configuration';
...
$lang['xs_config_title'] = 'eXtreme Styles module v{VERSION} settings';
...
$lang['xs_error_demo_edit'] = 'you cannot edit file in demo modulee';
$lang['xs_error_not_installed'] = 'eXtreme Styles module is not installed. You forgot to upload includes/template.php';

/*
* chmodule
*/

$lang['xs_chmodule'] = 'CHmodule';
$lang['xs_chmodule_return'] = '<br /><br /><a href="{URL}">Click here</a> to return to configuration.';
$lang['xs_chmodule_message1'] = 'Configuration changed.';
$lang['xs_chmodule_error1'] = 'Cannot change access modulee to cache directory';
...
$lang['xs_import_explain'] = 'This feature allows you to import styles. It can also automatically install and update styles.<br /><br />Note: If you have added any modules (except for eXtreme Styles module) on this forum then you should be careful when importing styles because styles might not be compatible with your forum. You can only install styles that have the same moduleifications as the other styles that you\'ve configured on your forums.';
...
$lang['xs_style_header_error_invalid2'] = 'Invalid file. Presumeably, the file is not an eXtreme Styles module-compatible style or invalid version.';
...
$lang['xs_import_nowrite_cache'] = 'Cannot write to cache. This function requires cache to be writable. Check module configuration.<br /><br /><a href="{URL1}">Click here</a> to make cache writable.<br /><br /><a href="{URL2}">Click here</a> to return to import page.';
...
$lang['xs_clone_style_explain'] = 'This feature allows you to quickly clone style or whole template.<br /><br />Warning: If you are copying template make sure author of original template allows you to do this (unless it is subSilver - you can do whatever you want with subSilver). Usually authors allow to moduleify their styles, but moduleified style should not be distributed.';
...
$lang['xs_fileman_filetime'] = 'moduleification';
...
$lang['xs_updates_comment'] = 'This feature checks for updates of some styles and modules. It works only with items that have relevant update information.';
