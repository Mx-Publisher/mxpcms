...
* @version $Id: template.php,v 1.3 2010/10/16 04:08:34 orynider Exp $
* @copyright (c) 2002-2007 [CyberAlien, OryNider] mxBB Project Team
...
class Template {
	...
	{
		global $board_config, $phpbb_root_path, $mx_root_path, $phpEx;
