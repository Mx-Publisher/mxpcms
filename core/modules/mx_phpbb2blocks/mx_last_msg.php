...
* @version $Id: mx_last_msg.php,v 1.2 2009/01/24 16:48:07 orynider Exp $
...
$sql = "SELECT t.topic_title, p.topic_id, t.topic_status, t.topic_replies, t.topic_type, t.topic_last_post_id, p.post_time, f.forum_name, f.forum_id,
...
for( $row_count = 0; $row_count < count($postrow); $row_count++ )
{
	...
	else
	{
		...
		{
			$replies = $postrow[$row_count]['topic_replies'];
