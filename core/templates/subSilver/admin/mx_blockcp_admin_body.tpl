<!-- dynamic_select -->
<script type="text/javascript" src="{MX_DYN_PATH}modules/mx_ajax/DynamicOptionList.js"></script>
...
<table width="100%" cellpadding="1" cellspacing="0" border="0" class="forumline" align="center">
	...
	<tr>
		<!-- BEGIN blockcp_general_add -->
		<th width="20%" class="thHead" style="cursor:pointer;cursor:hand;" onclick="blockcp_onMenuCatClick('general_add','adminBlockCP_');">
			&nbsp;&nbsp;<img name="adminBlockCP_image_general_add" src="{IMG_URL_GENERAL_ADD}" border="0" align="absmiddle">&nbsp;{blockcp_general_add.L_TITLE}
		</th>
		<!-- END blockcp_general_add -->	
 	...
 	<tr>
 		<td class="row1" colspan="2">
	 			...
	 			<table width="100%" cellpadding="2" cellspacing="0" border="0" align="center">
						...
						<td class="row1">	
							...
							<table cellspacing="1" cellpadding="4" border="0">
								<tr> 
									...
									<td class="row3" align="center"><span class="topictitle">{blockcp_general_add.block_auth_titles.CELL_TITLE}</span></td>
								...
								<!-- BEGIN block_auth_data -->
									<td>
										<table>
											<tr>
									    	  	<td class="row1" align="center">{blockcp_general_add.block_auth_data.S_AUTH_LEVELS_SELECT}</td>
											</tr>    	  
										</table>
									</td>
								<!-- END block_auth_data -->
					...
					<tr>
						<td class="row1" height="25" align="center" colspan="2">{blockcp_general_add.S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{blockcp_general_add.S_SUBMIT}" class="mainoption" />{CANCEL}</td>
					</tr>				
				</table>
				</form>
 	...
 	<tr>
 		<td class="row1" colspan="2">
	 			...
	 			<table width="100%" cellpadding="2" cellspacing="0" border="0" align="center">
					...
					<!--
					<tr> 
						<td class="row1" width="50%" align="right"><b>{L_FUNCTION}</b></td>
					  	<td class="row1">{S_FUNCTION_LIST}</td>
					</tr>
					-->
					<!-- END is_auth -->
					...
					<tr>
						<td class="row1" height="25" align="center" colspan="2">{blockcp_general.S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{blockcp_general.S_SUBMIT}" class="mainoption" />{CANCEL}</td>
					</tr>				
				</table>
				</form>
...
<!-- BEGIN blockcp_settings -->
 	<tr>
 		<td class="row1" colspan="2">
 				<form action="{S_ACTION}" method="post" name="post" onsubmit="return checkForm(this)">
 				<table width="100%" cellpadding="2" cellspacing="0" border="0" align="center">
					<tr> 
