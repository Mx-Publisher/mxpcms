...
function doOnLoadMenuACP()
{
	...
	if( getObj('adminPage_' + '{NAV_PAGE_ID}') )
	{
		if ( '{NAV_PAGE_ID}' > 0 )
		{
			cat_id = '{NAV_PAGE_ID}';
...
<!-- BEGIN has_columns -->
<!-- dynamic_select -->
<script type="text/javascript" src="../modules/mx_ajax/DynamicOptionList.js"></script>
			...
			<form method="post" name="jumpbox" action="{S_ACTION}">
				<table width="100%" cellspacing="0" cellpadding="0" border="0" >
					...
					<tr>
						<td align="left">
							<span class="genmed">
							<b>{L_SELECT_SORT_METHOD}:</b>&nbsp;
							<select name="sort_method">
								<option {S_PAGE_TITLE} value='page_name'>{L_SORT_TITLE}</option>
								<option {S_PAGE_DESC} value='page_desc'>{L_SORT_DESC}</option>
								<option {S_PAGE_ID} value='page_id'>{L_SORT_ID}</option>
							</select>
								&nbsp;<b>{L_ORDER}:</b>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="forumline" align="center">
	...
	<tr>
		...
		<th width="33%" class="thHead" align="left" style="cursor:pointer;cursor:hand;" onclick="onMenuCatClick('Template','adminPage_');">&nbsp;<img name="adminPage_image_Template" src="{IMG_URL}" border="0" align="absmiddle">&nbsp;{L_TITLE_TEMPLATE}</th>
 	</tr>
</table>
													...
													<tr>
														...
														<td>											
															...
															<table width="100%" cellpadding="1" cellspacing="2" border="0" align="center">
																...
																<tr>
																  	<td width="50%" align="right" >{L_PAGE_ICON}</td>
																...
																<tr>
																  	<td width="50%" align="right" >{L_PAGE_GRAPH_BORDER}<br /><span class="gensmall">{L_PAGE_GRAPH_BORDER_EXPLAIN}</span></td>
																  	<td><input type="text" size="45" name="page_graph_border" value="{pages.E_PAGE_GRAPH_BORDER}" class="post" /></td>
																</tr>
																<tr>
																...
																<tr>
																	...
																	<td>		
																		<table width="100%" cellpadding="2" cellspacing="0" border="0" align="center">
																			...
																			<!-- BEGIN blockrow -->
																			<tr>
																				<td class="row1" >&nbsp;&nbsp;<img src="{IMG_ICON_BLOCK}" border="0" align="absmiddle">&nbsp;<span class="gen">{pages.columnrow.blockrow.BLOCK_TITLE}</span> <span class="gensmall"><i>{pages.columnrow.blockrow.BLOCK_LAST_EDITED}</i></span> <span class="gensmall">{pages.columnrow.blockrow.BLOCK_DESC}</span></td>
