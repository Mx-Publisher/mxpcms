...
<!-- END switch_view -->
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tr> 
					<td>
							<a href="{U_PORTAL_HOME}"><img src="../templates/subSilver/images/logo_mx-system.gif" border="0" alt="{L_INDEX}" vspace="1" /></a>
					</td>
						...
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								<td align="center" valign="top" nowrap>
									<span class="mainmenu">&nbsp;
										<a href="{U_PORTAL_FORUM}" class="mainmenu"><img src="templates/SubSilver/images/icon_mini_message.gif" width="12" height="13" border="0" alt="{L_PORTAL_FORUM}" hspace="3" />{L_PORTAL_FORUM}</a>
