...
/*
  ...
  Modified by Haplo (jonohlsson@hotmail.com)
...
td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom,td.catHeadWelcome {
...
*/
td.cat,td.catHead,td.catBottom,td.catHeadWelcome {
	height: 29px;
...
/* Added by Jon */
td.catHeadWelcome { font-size: {T_FONTSIZE3}px; border-width: 0px 0px 0px 0px; }
...
<!-- BEGIN switch_view -->
<table width="{BLOCK_SIZE}" cellspacing="0" cellpadding="10" border="0" align="top">
  <tr> 
...
<!-- END switch_view -->
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<tr> 
					<td>
							<a href="{U_INDEX}?page=2"><img src="{U_PORTAL_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/logo_mx-system.gif" border="0" alt="{L_INDEX}" vspace="1" /></a>
					</td>
						...
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								<td align="center" valign="top" nowrap>
									<span class="mainmenu">&nbsp;
										<a href="{U_FAQ}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_faq.gif" width="12" height="13" border="0" alt="{L_FAQ}" hspace="3" />{L_FAQ}</a>
									</span>
									<span class="mainmenu">&nbsp; 
										<a href="{U_SEARCH}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_search.gif" width="12" height="13" border="0" alt="{L_SEARCH}" hspace="3" />{L_SEARCH}</a>&nbsp; 
										<a href="{U_MEMBERLIST}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_members.gif" width="12" height="13" border="0" alt="{L_MEMBERLIST}" hspace="3" />{L_MEMBERLIST}</a>&nbsp;
										<a href="{U_GROUP_CP}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_groups.gif" width="12" height="13" border="0" alt="{L_USERGROUPS}" hspace="3" />{L_USERGROUPS}</a>&nbsp;
 									</span>
								</td>
							</tr>
							<tr>
								<td height="25" align="center" valign="top" nowrap>
									<span class="mainmenu">&nbsp;
										<!-- BEGIN switch_user_logged_out -->
											<a href="{U_REGISTER}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_register.gif" width="12" height="13" border="0" alt="{L_REGISTER}" hspace="3" />{L_REGISTER}</a>&nbsp; &nbsp;

										<!-- END switch_user_logged_out -->
										<a href="{U_PROFILE}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_profile.gif" width="12" height="13" border="0" alt="{L_PROFILE}" hspace="3" />{L_PROFILE}</a>&nbsp; &nbsp;
										<a href="{U_PRIVATEMSGS}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_message.gif" width="12" height="13" border="0" alt="{PRIVATE_MESSAGE_INFO}" hspace="3" />{PRIVATE_MESSAGE_INFO}</a>&nbsp; &nbsp;
										<a href="{U_LOGIN_LOGOUT}" class="mainmenu"><img src="{U_PHPBB_ROOT_PATH}{TEMPLATE_ROOT_PATH}images/icon_mini_login.gif" width="12" height="13" border="0" alt="{L_LOGIN_LOGOUT}" hspace="3" />{L_LOGIN_LOGOUT}</a>
									&nbsp;</span>
								</td>
							</tr>
						</table>
