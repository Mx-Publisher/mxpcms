...
th.thCornerL { font-size: {T_FONTSIZE3}px; border-width: 1px 0px 0px 1px; }
...
<table width="100%" cellspacing="0" cellpadding="10" border="0" align="center"> 
	<tr> 
 		<td class="bodyline"><table width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr> 
 				<td align="center" valign="middle"><a href="{U_PORTAL_HOME}"><img src="../templates/subSilver/images/logo_mx-system.gif" border="0" alt="{L_INDEX}" vspace="1"/></a></td>
			</tr> 
			<tr> 
				...
				<table cellspacing="6" cellpadding="2" border="0">
					<tr> 
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PORTAL_HOME}" class="mainmenu"><img src="../templates/subSilver/images/nav_home.gif"  border="0" alt="{L_HOME}" hspace="3" /></a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PORTAL_FORUM}" class="mainmenu"><img src="../templates/subSilver/images/nav_forum.gif"  border="0" alt="{L_FORUM}" hspace="3" /></a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PROFILE}" class="mainmenu"><img src="../templates/subSilver/images/nav_profile.gif"  border="0" alt="{L_PROFILE}" hspace="3" /></a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_FAQ}" class="mainmenu"><img src="../templates/subSilver/images/nav_help.gif" border="0" alt="{L_FAQ}" hspace="3" /></a></span></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_SEARCH}" class="mainmenu"><img src="../templates/subSilver/images/nav_search.gif" border="0" alt="{L_SEARCH}" hspace="3" /></a></span></td>
            <td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_MEMBERLIST}" class="mainmenu"><img src="../templates/subSilver/images/nav_members.gif" border="0" alt="{L_MEMBERLIST}" hspace="3" /></a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PRIVATEMSGS}" class="mainmenu"><img src="../templates/subSilver/images/nav_email.gif" border="0" alt="{PRIVATE_MESSAGE_INFO}" hspace="3" /></a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_LOGIN_LOGOUT}" class="mainmenu"><img src="../templates/subSilver/images/nav_login.gif" border="0" alt="{L_LOGIN_LOGOUT}" hspace="3" /></span></td>
	
						<!-- BEGIN switch_user_logged_out -->
						<td height="15" align="center" valign="top" nowrap><a href="{U_REGISTER}" class="mainmenu"><img src="../templates/subSilver/images/nav_register.gif" border="0" alt="{L_REGISTER}" hspace="3" /></a></span></td>
						&nbsp;
						<!-- END switch_user_logged_out -->
						</td>
					</tr>
					<tr> 
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PORTAL_HOME}" class="mainmenu">{L_PORTAL_HOME}</a></span></td>
						<td height="15" align="center" valign="top" nowrap><span class="mainmenu"><a href="{U_PORTAL_FORUM}" class="mainmenu">{L_PORTAL_FORUM}</a></span></td>
