...
// -->
{POWERED_BY} <a href="http://www.mx-publisher.com/" target="_mx-system" class="copyright">MX-Publisher (MXP)</a> {MX_VERSION} &copy; 2001-2007 &amp; <a href="http://www.phpbb.com/" target="_phpbb" class="copyright">phpBB</a> {PHPBB_VERSION} &copy; 2001, 2003 phpBB Group | <a href="{MXBB_EXTRA_URL}" target="_phpbb" class="copyright">{MXBB_EXTRA}</a>
</div>
		</td>
	</tr>
</table>
