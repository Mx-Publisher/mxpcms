...
* @version $Id: lang_admin.php,v 1.1 2009/01/21 15:46:03 orynider Exp $
...
$lang['MXP_adminCP']			= 'Mx-Publisher Administraţie';	
...
$lang['MXP_Version_outdated'] = 'Se pare ca instalarea ta MXP <b>nu</b> este la zi. Actualizări există pentru versiunea ta de MXP. Te rog viziteză <a href="http://www.mx-publisher.com/index.php?page=4&action=file&file_id=2" target="_new">downloadare pachetul MXP Core</a> pt. a obţine ultima versiune.';
$lang['MXP_Latest_version_info'] = 'Ultima veriune disponibilă este <b>MXP %s</b>. ';
$lang['MXP_Current_version_info'] = 'Tu ai <b>MXP %s</b>.';
$lang['MXP_Mailing_list_subscribe_reminder'] = 'Pentru ultimile informaţii de ştiri şi actualizări pentru MXP, de ce nu <a href="http://lists.sourceforge.net/lists/listinfo/MXP-news" target="_new">înscriete la lista de mailuri</a>.';
