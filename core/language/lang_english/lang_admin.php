...
$lang['Session_nobackend_explain'] 	= 'The MX-Publisher-IWizard has not detected any phpBB boards installed on this server using this server username. <br />Select here a fresh \'Internal\' setup. You may update this setting later in the MX-Publisher adminCP.';
...
$lang['mxBB_Version_outdated'] = 'Your MX-Publisher installation does <b>not</b> seem to be up to date. Updates are available for your version of MX-Publisher. Please visit <a href="http://mxpcms.sourceforge.net/download" target="_new">the MX-Publisher Core package download</a> to obtain the latest version.';
