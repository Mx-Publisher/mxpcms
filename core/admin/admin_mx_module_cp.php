 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: admin_mx_module_cp.php,v 1.3 2010/10/16 04:05:59 orynider Exp $
 */
...
if ( empty($nav_module_id) )
{
	...
	$nav_module_id = !empty($HTTP_COOKIE_VARS[$cookie_tmp]) ? $HTTP_COOKIE_VARS[$cookie_tmp] : '';
}
...
if ( isset( $HTTP_POST_VARS['include_block_quickedit'] ) )
{
	switch ( $HTTP_POST_VARS['include_block_quickedit'] )
	{
		case '0':
...
if ( isset( $HTTP_POST_VARS['include_block_private'] ) )
{
	switch ( $HTTP_POST_VARS['include_block_private'] )
	{
		case '0':
...
$template->set_filenames(array(
	'admin_block' => 'admin/mx_modulecp_admin_body.tpl')
);
...
$template->assign_vars(array(
	'MODULE_SELECT_BOX' => $module_select_box
));
