...
* @version $Id: admin_mx_gen_cache.php,v 1.2 2009/01/24 16:45:47 orynider Exp $
...
if( !$generate )
{
	...
	$message .= '<form action="' . append_sid(PORTAL_URL . "admin/admin_mx_gen_cache.$phpEx") . '" method="post">';
...
{
	//
	// Update mxBB page/block cache
	//
	$mx_cache->trash(); // Empty cache folder
	$mx_cache->update(); // Rgenerate all page_ and block_ files
