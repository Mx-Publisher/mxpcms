 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: page_header_admin.php,v 1.3 2010/10/16 04:05:59 orynider Exp $
 */
...
// in a template. Note that all URL's should be wrapped in mx_append_sid, as
...
//	'PAGE_TITLE' => $page_title,
	...
	'S_LOGIN_ACTION' => mx_append_sid($mx_root_path.'login.'.$phpEx),
	'S_JUMPBOX_ACTION' => mx_append_sid($phpbb_root_path.'viewforum.'.$phpEx),
	...
	//
	// These theme variables are not used for Mx-Portal, since MXP require a theme.css file
	//
