...
* @version $Id: page_header_admin.php,v 1.2 2009/01/24 16:45:47 orynider Exp $
...
$template->assign_vars(array(
	...
	'PAGE_TITLE' => isset($page_title) ? $page_title : $mx_user->lang('Admin'),
	...
	'S_CONTENT_DIRECTION' => ($lang['DIRECTION']) ? $lang['DIRECTION'] : 'ltr',
	...
	*/
	...
	//+ MX-Publisher
	'L_MX_ADMIN' => !empty($lang['Mx-Publisher_adminCP']) ? $lang['Mx-Publisher_adminCP'] : $lang['mxBB_adminCP'],
	...
	'GECKO' => strstr(((isset($_SERVER['HTTP_USER_AGENT'])) ? $_SERVER['HTTP_USER_AGENT'] : getenv('HTTP_USER_AGENT')), 'Gecko'),
