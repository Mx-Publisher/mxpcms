 ...
 * -------------------------------------------------------------------------
 * 
 *    $Id: index.php,v 1.4 2010/10/16 04:05:59 orynider Exp $
 */
...
{
	global $phpEx, $template, $lang, $board_config, $phpbb_root_path;
...
if( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'left' )
{
	...
	$admincp_nav_icon_url = PORTAL_URL . TEMPLATE_ROOT_PATH . 'images';	
...
elseif( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'right' )
{
	...
	{
		@fputs($fsock, "GET /updatecheck/27x.txt HTTP/1.1\r\n");
...
{ 
	...
	$template->assign_vars(array(
		'ADMIN_TITLE' => 'Administrator Pannel',	
